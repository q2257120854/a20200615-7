 ...
 <div class="rt_content">
      ...
      <table class="table">
       ...
       <tr>
		...
		<td class="center">
			<?php if($vo['status'] == '0'): ?><font style="color:red;">【未读】</font><?php endif; if($vo['status'] == '1'): ?><font style="color:#3c7fff;">【未处理】</font><?php endif; if($vo['status'] == '2'): ?><font style="color:green;">【已处理】</font><?php endif; ?>
			<?php echo $vo['title']; ?>
		</td>
		<td class="center">
			<?php echo $vo['name']; ?>
		...
		<td class="center">
			<mark style=""><?php echo $vo['remark']; ?></mark>
		</td>		
        <td class="center">
        ...
        <td class="center">
		 <a href="<?php echo url('other/message_view'); ?>?id=<?php echo $vo['id']; ?>" title="查看" class="link_icon">&#118;</a>
...
$(document).ready(function() {
  ...
  //删除
	$('.del').click(function(event){
		...
		if (confirm("确定要删除吗？")) {
			$.ajax({
				url:"<?php echo url('other/message_del'); ?>",
				dataType:"json",
				type:'POST',
				cache:false,
	...
	$('#delid').click(function(event){
		...
		if (confirm("确定要删除吗？")) {
			$.ajax({
				url:"<?php echo url('other/message_delmost'); ?>",
				dataType:"json",
				type:'POST',
				cache:false,
