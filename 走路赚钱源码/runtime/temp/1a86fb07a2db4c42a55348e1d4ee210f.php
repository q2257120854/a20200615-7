<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:83:"/www/wwwroot/leetao.cn/public/../application/admincmsby/view/adminbrother/edit.html";i:1524577366;s:76:"/www/wwwroot/leetao.cn/public/../application/admincmsby/view/index/base.html";i:1557824308;s:79:"/www/wwwroot/leetao.cn/public/../application/admincmsby/view/public/header.html";i:1557838008;s:77:"/www/wwwroot/leetao.cn/public/../application/admincmsby/view/public/left.html";i:1560258804;s:79:"/www/wwwroot/leetao.cn/public/../application/admincmsby/view/public/footer.html";i:1524125862;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8"/>
      ...
      <ul class="ulColumn2">
       ...
       <li>
        ...
        <select class="select" name="group">
         ...
         <option value="<?php echo $vo['id']; ?>" data-power="<?php echo $vo['power']; ?>" <?php if($vo['id'] == $result['group']): ?>selected<?php endif; ?>>&nbsp;<?php echo $vo['name']; ?>&nbsp;</option>
		 <?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
       </li>
       <li>
        <span class="item_name" style="width:120px;">电子邮箱：</span>
        <input type="email" class="textbox textbox_225" value="<?php echo $result['email']; ?>" name="email" placeholder="电子邮件地址..."/>
       </li>
       <li>
...
$(document).ready(function() {
  //测试提交，对接程序删除即可
	$('#submit').click(function(event){
		...
		$.ajax({
			url:"<?php echo url('admin/edit_do'); ?>",
			dataType:"json",
			type:'POST',
			cache:false,
