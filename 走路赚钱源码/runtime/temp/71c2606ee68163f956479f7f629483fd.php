 ...
 <div class="rt_content">
      ...
      <table class="table">
       ...
       <tr class="id_<?php echo $vo['id']; ?>">
        ...
        <td class="center"><?php echo $vo['ip']; ?></td>
		<td class="center"><?php echo date("Y-m-d H:i:s",$vo['addtime']); ?></td>
        <td class="center"><?php if($vo['status'] == 1): ?><a title="开启" class="link_icon" >&#89;</a><?php else: ?><a title="关闭" class="link_icon" style="color:red;">&#88;</a><?php endif; ?></td>
        <td class="center">
...
$(document).ready(function() {
  ...
  //删除
	$('.del').click(function(event){
		...
		$.ajax({
			url:"<?php echo url('system/operate_del'); ?>",
			dataType:"json",
			type:'POST',
			cache:false,
	...
	$('#delid').click(function(event){
		...
		$.ajax({
			url:"<?php echo url('system/Op_delmost'); ?>",
			dataType:"json",
			type:'POST',
			cache:false,
