...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
      ...
      <section class="mtb">
	   ...
	   &nbsp;&nbsp;订单号&nbsp;&nbsp;
	    <input type="text" class="textbox textbox_225" placeholder="输入订单号..." name="orderid" value="<?php echo $orderid; ?>" />
       <input type="submit" value="查询" class="group_btn"/>
	   
	   <a href="<?php echo url('trade/tradelog'); ?>" class="all"/>全部</a> 
	   </form>
      </section>
      <table class="table">
       <tr>
       ...
       <tr class="id_<?php echo $vo['id']; ?>">
		...
		<td class="center"  style="font-weight:600;"><?php echo $vo['sell_user']; ?></td>
		<td class="center">
				
		<?php echo $vo['sell_old']; ?>
		
		</td>
		<td class="center" style="color:#0041ff;">
				
		<?php echo $vo['sell_new']; ?>
		
		</td>
		<td class="center" style="font-weight:600;">
		<?php echo $vo['buy_user']; ?>
		</td>
		<td class="center">	
		...
		<td class="center">
			￥ <span style="color:red;"><?php echo $vo['num']; ?></span>
		</td>
...
$(document).ready(function() {
	...
	$('.del').click(function(event){
		...
		if (confirm("确定要删除吗？")) {
			$.ajax({
				url:"<?php echo url('trade/tradelog_del'); ?>",
				dataType:"json",
				type:'POST',
				cache:false,
	...
	$('#delid').click(function(event){
		...
		if (confirm("确定要删除吗？")) {
			$.ajax({
				url:"<?php echo url('trade/tradelog_delmost'); ?>",
				dataType:"json",
				type:'POST',
				cache:false,
