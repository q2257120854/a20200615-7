 ...
 <div class="rt_content">
	...
	<!--   <form enctype="multipart/form-data" id="uploadForm"> -->
       ...
       <li>
        ...
        <input type="text" class="textbox textbox_295" name="title" value="<?php echo $result['title']; ?>" placeholder="公司名称..."/>
       ...
       <li>
        ...
        <label class="uploadImg">
		 ...
		 <?php if($result['weixin_pic'] != '0'): ?>
		 <img id="weixin_pic" src="<?php echo $result['weixin_pic']; ?>" >
		 <?php else: ?>
		 <img id="weixin_pic" src="" >
		 <?php endif; ?>		 
		 <input type="hidden" name="primary_weixin" value="<?php echo $result['weixin_pic']; ?>">
         <span>上传站点logo</span>
        </label>
       </li>
       ...
       <li>
        ...
        <input type="text" class="textbox textbox_295"  name="phone" value="<?php echo $result['phone']; ?>" placeholder="手机..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">固话：</span>
        <input type="text" class="textbox textbox_295"  name="tel" value="<?php echo $result['tel']; ?>" placeholder="固话..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">QQ：</span>
        <input type="text" class="textbox textbox_295" name="qq" value="<?php echo $result['qq']; ?>"  placeholder="QQ..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">Email：</span>
        <input type="text" class="textbox textbox_295" name="email" value="<?php echo $result['email']; ?>"  placeholder="Email..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">联系人：</span>
        <input type="text" class="textbox textbox_295" name="contacts" value="<?php echo $result['contacts']; ?>"  placeholder="联系人..."/>
       </li>
       <li>
        <span class="item_name" style="width:120px;">公司地址：</span>
        <input type="text" class="textbox textbox_295"  name="address" value="<?php echo $result['address']; ?>" placeholder="公司地址..."/>
       </li>
	    <!--内容详情-->
       <li>
        <span class="item_name" style="width:120px;">详情/地图：</span>
        <script id="content" type="text/plain" style="height:500px; margin-top: 0px;"><?php echo htmlspecialchars_decode($result['content']); ?></script>
       </li>
       <li>
...
$(".uploadImg").on("change",function(){
	...
	$('#submit').click(function(event){
		...
		$.ajax({
			url:"<?php echo url('other/contact_edit'); ?>",
			dataType:"json",
			type:'POST',
			cache:false,
