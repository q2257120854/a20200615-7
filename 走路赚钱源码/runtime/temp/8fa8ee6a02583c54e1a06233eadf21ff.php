 ...
 <div class="rt_content">
      ...
      <section class="mtb">
	   ...
	   <select class="select" name="status">
			...
			<option value="2" <?php if($status == '2'): ?>selected<?php endif; ?>>&nbsp;&nbsp;&nbsp;上架&nbsp;&nbsp;&nbsp;</option>

       </select>
       <input type="submit" value="查询" class="group_btn"/>
	   <a href="<?php echo url('ore/lists'); ?>" class="all"/>全部</a> 
	   </form>
      </section>
      <table class="table">
       <tr>
       ...
       <tr class="id_<?php echo $vo['id']; ?>">
        ...
        <td class="center">
			...
			<font style="font-weight:600;"><?php echo $vo['output']; ?></font>
		</td>
        <td class="center">
			<font ><?php echo $vo['profit']; ?>%</font>
		</td>
		<td class="center">
			<font ><?php echo $vo['day_gain']; ?></font>
		</td>
		<td class="center">
			<font ><?php echo $vo['ore_coin']; ?></font>
		</td>
		<td class="center">
			<font ><?php echo $vo['cyc']; ?></font>
		</td>
		<td class="center">
			<?php if($vo['status'] == '0'): ?>
		...
		<td class="center">
		 <a href="<?php echo url('ore/edit'); ?>?id=<?php echo $vo['id']; ?>" title="编辑" class="link_icon">&#101;</a>
