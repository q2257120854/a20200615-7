...
class View
{
    ...
    public function __construct($engine = [], $replace = [])
    {
        ...
        $baseReplace = [
            ...
            '__ADMIN_CSS__'    => $root . '/static/admin/css',
            '__ADMIN_JS__'     => $root . '/static/admin/js',
            '__ADMIN_IMG__'     => $root . '/static/admin/images',
            '__INDEX_CSS__'    => $root . '/static/index/css',
            '__INDEX_JS__'     => $root . '/static/index/js',
            '__INDEX_IMG__'     => $root . '/static/index/images',
			'__INDEX_PIC__'     => $root . '/static/index/picture',
            '__HOME_CSS__'    => $root . '/static/home/css',
            '__HOME_JS__'     => $root . '/static/home/js',
            '__HOME_IMG__'     => $root . '/static/home/img',
        ];
