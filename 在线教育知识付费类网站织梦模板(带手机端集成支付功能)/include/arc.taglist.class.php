...

{
...

    {
...

        {
            ...
            $prepage.=$GLOBALS['rewrite_open']==1 ? "<li><a href='".$purl."/$prepagenum.html'>上一页</a></li>\r\n" : "<li><a href='".$purl."/$prepagenum/'>上一页</a></li>\r\n";

            $indexpage=$GLOBALS['rewrite_open']==1 ? "<li><a href='".$purl."/1.html'>首页</a></li>\r\n" : "<li><a href='".$purl."/1/'>首页</a></li>\r\n";
...

        {
            ...
            $nextpage.=$GLOBALS['rewrite_open']==1 ? "<li><a href='".$purl."/$nextpagenum.html'>下一页</a></li>\r\n" : "<li><a href='".$purl."/$nextpagenum/'>下一页</a></li>\r\n";

            $endpage=$GLOBALS['rewrite_open']==1 ? "<li><a href='".$purl."/$totalpage.html'>末页</a></li>\r\n" : "<li><a href='".$purl."/$totalpage/'>末页</a></li>\r\n";
...

        {
...

            {
                ...
                $listdd.=$GLOBALS['rewrite_open']==1 ? "<li><a href='".$purl."/$j.html'>".$j."</a></li>\r\n" : "<li><a href='".$purl."/$j/'>".$j."</a></li>\r\n";
