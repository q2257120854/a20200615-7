...

{
...

    {
        ...
        $innertext = "<input name=\"$fieldname\" value=\"$nowtime\" type=\"text\" id=\"$fieldname\" style=\"\" class=\"intxt\"  />";
...

    {
        ...
        $innertext = "<input type='text' name='$fieldname' id='$fieldname' style=''  class='intxt' value='$dfvalue' />\r\n";
...

{
...

    {
        ...
        $innertext = "<input type='text' name='$fieldname' id='$fieldname' style=''  class='intxt' value='$fvalue' />\r\n";
