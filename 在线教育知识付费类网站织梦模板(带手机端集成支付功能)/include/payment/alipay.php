...
return $msg = "您提交的订单已处理完成！<br> <a class='likx' href='/'>返回首页</a> <a class='likx2' href='/member/'>支付已完成</a>";
            ...
            $row = $this->dsql->GetOne("SELECT * FROM #@__member_operation WHERE buyid = '{$order_sn}'");
            //获取订单信息，检查订单的有效性
            if(!is_array($row)||$row['sta']==2) return $msg = "您提交的订单已处理完成！<br> <a class='likx' href='/'>返回首页</a> <a class='likx2' href='/member/'>支付已完成</a>";
            elseif($row['money'] != $_GET['total_fee']) return $msg = "支付失败，支付金额".$_GET['total_fee']."与商品总价".$row['money']."不相符!";
            $ordertype = "member";
            $product =    $row['product'];
            $pname= $row['pname'];
            $pid=$row['pid'];
        ...
        {
            return $msg = "支付失败！<br> <a class='likx2' href='/'>返回首页</a> <a class='likx' href='/member/'>会员中心</a>";
        }
    ...
    function success_mem($order_sn,$pname,$product,$pid){
        ...
        if($product=="card")
        {
            ...
            {
                $this->log_result("verify_success,订单号:".$order_sn); //将验证结果存入文件
 return $msg = "<font color='red'>".$oldinf."</font><br> <a class='likx2' href='/'>返回首页</a> <a class='likx' href='/member/'>会员中心</a>";				//20170115    return $oldinf;
            } else {
                $this->log_result ("verify_failed,订单号:".$order_sn);//将验证结果存入文件
                return $msg = "支付失败！<br> <a class='likx2' href='/'>返回首页</a> <a class='likx' href='/member/'>会员中心</a>";
            }
        /* 改变会员订单状态_支付成功 */
            ...
            {
                $this->log_result("verify_success,订单号:".$order_sn); //将验证结果存入文件
return $msg = "会员升级成功！<br> <a class='likx2' href='/'>返回首页</a> <a class='likx' href='/member/'>会员中心</a>";
					 //20170115    return "会员升级成功！";
            } else {
                $this->log_result ("verify_failed,订单号:".$order_sn);//将验证结果存入文件
return $msg = "会员升级失败！<br> <a class='likx2' href='/'>返回首页</a> <a class='likx' href='/member/'>会员中心</a>";
