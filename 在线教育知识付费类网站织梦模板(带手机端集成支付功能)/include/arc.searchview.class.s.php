...
class SearchView
{
    ...
    $searchtype='',$starttime=0,$upagesize=20,$kwtype=1,$mid=0)
    {
        ...
        if ($channeltype == 17){$tempfile = DEDEMEMBER."/d1w2z3/list_mfvideo.htm";} 
		else if ($channeltype == 18){$tempfile = DEDEMEMBER."/d1w2z3/list_doc.htm";} 
		else if ($channeltype == 6){$tempfile = DEDEMEMBER."/d1w2z3/list_shop.htm";} 
		else {$tempfile = DEDEMEMBER."/d1w2z3/list_news.htm";} 
		// $tempfile = DEDEMEMBER."/".$this->TypeLink->TypeInfos['templist'];
