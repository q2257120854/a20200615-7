...
class DedeQrcode
{
	...
	public function initialize($config = array()) {
		...
		require_once dirname(__FILE__)."/qrcode/qrimage.php";
		require_once dirname(__FILE__)."/qrcode/qrinput.php";
		require_once dirname(__FILE__)."/qrcode/qrbitstream.php";
		require_once dirname(__FILE__)."/qrcode/qrsplit.php";
		require_once dirname(__FILE__)."/qrcode/qrrscode.php";
