...
///////////////////////mmm
if ( ! function_exists('mGetEditor'))
{
    function mGetEditor($fname, $fvalue, $nheight="350", $etype="Basic", $gtype="print", $isfullpage="FALSE",$bbcode=false)
    {
        if(!function_exists('mSpGetEditor'))
        {
            require_once(DEDEINC."/inc/inc_fun_funAdmin.php");
        return mSpGetEditor($fname, $fvalue, $nheight, $etype, $gtype, $isfullpage, $bbcode);
        }
    }
}
