...

{
...

    {
...

        {
            ...
            $sta .= "<div class=\"content-message-grade\">帐号等级：<span class=\"zhanghao-dj\">普通会员</span> 开通VIP套餐，更优惠、更划算 ！<span class=\"vip-shijian\"><a href=\"buyhui.php\" class=\"vip-goumai\">立即开通VIP套餐</a></span></div>";

        }else   if($this->M_Rank==10){

            $row = $dsql->GetOne("Select membername From `#@__arcrank` where rank='".$this->M_Rank."'");

            $sta .= "<div class=\"content-message-grade\">帐号等级：<span class=\"zhanghao-dj\">".$row['membername']." </span> 开通VIP套餐，更优惠、更划算 ！<span class=\"vip-shijian\"><a href=\"buyhui.php\" class=\"vip-goumai\">立即开通VIP套餐</a></span></div>
...
";
            ...
            $sta .= "<div class=\"content-message-grade\">帐号等级：<span class=\"zhanghao-vip\">".$row['membername']."</span>";

            $rs = $dsql->GetOne("Select id From `#@__admin` where userid='".$this->M_LoginID."'");

            if(!is_array($rs)){

                if($this->M_Rank>10 && $this->M_HasDay>0) $sta .= "  您的VIP套餐有效期剩余<span class=\"vip-shijian\">".$this->M_HasDay."</span>天</div> ";

                elseif($this->M_Rank>10) $sta .= " <font color='red'>会员升级已经到期</font><span class=\"vip-shijian\"><a href=\"buyhui.php\" class=\"vip-goumai\">立即购买年费</a></span></div> ";
