...
class ListView
{
    ...
    function CountRecord()
    {
        ...
        //初始化列表模板，并统计页面总数
	/*	if($this->TypeID >16 and $this->TypeID <21){$tempfile = DEDEMEMBER."/templets/list_seausun17.htm";} 
		else if($this->TypeID >16 and $this->TypeID <21){$tempfile = DEDEMEMBER."/templets/list_seausun17.htm";} 
		else{$tempfile = DEDEMEMBER."/templets/list_seausun.htm";}*/
