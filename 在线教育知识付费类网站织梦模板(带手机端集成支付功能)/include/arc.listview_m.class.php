...

{
...

    {
		...
		$this->Fields['typedir']='m/'.$this->Fields['typedir'];
...

    {
...

        {
            ...
            $tempfile = $GLOBALS['cfg_basedir'].$GLOBALS['cfg_templets_dir']."/".$GLOBALS['cfg_df_style']."/list_default_m.htm";
...

    {
...

        {
...

            {
                ...
                $tempfile = $tmpdir."/".$GLOBALS['cfg_df_style']."/index_default_m.htm";
