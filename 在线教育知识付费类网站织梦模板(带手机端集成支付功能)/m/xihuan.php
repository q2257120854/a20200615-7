...

{
	...
	echo "<a href=\"/member\" class=\"gdb_guanzhu\">喜欢</a>";
...
if ($row['type'] == 'good'){	echo "<a  onclick=\"Loadxihuans('bad');\" class=\"gdb_guanzhu mall-hover\">已喜欢</a>";

}else{echo "<a  onclick=\"Loadxihuans('good');\"class=\"gdb_guanzhu\">喜欢</a>";
