...
if($dopost=='')
{
    $sql = "SELECT o.*,t.typename as pname,t.ico FROM `#@__shops_orders` o left join #@__arctype t on o.pid = t.id  WHERE o.userid='".$cfg_ml->M_ID."' and o.state > 0 ORDER BY o.stime DESC";
    $dlist = new DataListCP();
    $dlist->pageSize = 8;
    $dlist->SetTemplate("templets/operation_ke.htm");    
    $dlist->SetSource($sql);
    $dlist->Display(); 
}
else if($dopost=='del')
