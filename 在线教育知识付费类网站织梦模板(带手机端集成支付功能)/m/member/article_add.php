...
if(empty($dopost))
{
    ...
    include("templets/article_add.htm");
    exit();
}
/*------------------------------
...
{
    include('inc/archives_check.php');
    ...
    if($litpic!='')
    {
	   ...
	   if($channelid!='19' or $typeid!='7')
    {
        ShowMsg("现在只允许论坛发布", "-1");
    }

//文本框的换行转换	 $body = str_replace("\r\n","<p></p>",$body);
...
ShowMsg("成功发布文章", "content_list.php?channelid=19");
exit;
    //返回成功信息
    $msg =
    "请选择你的后续操作：
