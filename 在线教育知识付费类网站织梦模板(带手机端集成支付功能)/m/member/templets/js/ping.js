...
function MakeUpload(mnum)
{
	...
	for(startNum;startNum < endNum;startNum++)
	{
		...
		fhtml += "<td height=\"25\" colspan=\"2\">　<strong>图片"+startNum+"：</strong><input type=\"file\" name='imgfile"+startNum+"'  capture=\"camera\" style=\"width:200px\"  accept=\"image/x-png,image/gif,image/jpeg,image/bmp\" onChange=\"SeePicNew('divpicview"+startNum+"',this);\" /><div id='divpicview"+startNum+"' class='divpre'></div></td>";
		fhtml += "</tr>";
		fhtml += "<tr bgcolor=\"#FFFFFF\" style=\"display:none;\"> ";
