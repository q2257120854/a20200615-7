...
$price = $trr['price'];
    ...
    $tpl->LoadTemplate('templets/buy_action_payment.htm');
    $tpl->Display();
exit();
}
...
if($paytype == '10'){
	$url = '/member/weixinpay/example/weixin.php?ddh='.$aid;
	header("Location: $url"); 
	exit();
}	
    ...
    $dtp->LoadTemplate('templets/shops_action_payment.htm');
    $dtp->Display();
    exit();
}
