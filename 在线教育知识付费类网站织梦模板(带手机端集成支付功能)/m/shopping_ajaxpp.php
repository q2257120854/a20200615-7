...

{
...

    {
...

        {
            ...
            echo '<div class="pl-list-tjfk">验证码错误，请点击验证码图片更新验证码！</div>';
...

    {
        ...
        echo '<div class="pl-list-tjfk">无法查看未知文档的评论！</div>';
...

    {
        ...
        echo '<div class="pl-list-tjfk">这篇文档禁止评论！</div>';
...

    {
...

        {
            ...
            echo "<div class='pl-list-tjfk'>评论内容含有禁用词汇！</div>";
...

    {
        ...
        echo "<div class='pl-list-tjfk'>评论内容可能不合法或为空！</div>";
...

	{
		...
		echo "<div class='pl-list-tjfk'>管理员禁用了游客评论！<a href='{$cfg_cmspath}/member/login.php'>点击登录</a></div>";
...

    {
...

        {
            ...
            echo '<div class="pl-list-tjfk">您提交的过于频繁，请休息一下！</div>';
...

    {
            ...
            echo "<div class='pl-list-tjfk'>发表评论出错了！</div>";
  ...
  //给文章评分
...

    {
        ...
        echo '<div class="pl-list-tjfk">请耐心等待，正常24小时内，给予解答...</div>';
...
<div class="pl-list-avator"><img src="http://www.test.com<?php echo $mface;?>" title="<?php echo $username; ?>"></div>

<div class="pl-list-main">

<div class="pl-list-nick"><?php echo $username; ?></div>

<div class="pl-list-content"><?php echo ubb($msg); ?></div>

<div class="pl-list-btm clearfix">

<span class="pl-list-time fl"><?php echo GetDateMk($dtime); ?></span>

<span class="ok-btn fr" onclick="postBadGood('goodfb',<?php echo $id; ?>);"><em id='goodfb<?php echo $id; ?>'><?php if ($good == 0) $good ='';
...

{
    ...
    $querystring = "SELECT fb.*,mb.uname,mb.userid,mb.face as mface,mb.spacesta,mb.scores,mb.sex FROM `#@__feedback` fb
...
<div class="pl-list-nick"><?php echo $fields['uname']; ?></div>
...
<div class="pl-list-gfhf" <?php echo $gfhf; ?>><span style="color:#f30;">官方回复：</span><?php echo ubb($gmsg); ?></div>
...
<div id='showpage_min' style='display:none;'>";
 ...
 // echo "<span class=\"pageinfo\">总: {$allpage} 页/{$totalcount} 条评论</span> ";
  ...
  echo ($j==$curpage ? "<span class='cpage'>$j</span> " : "<a href='#commettop' onclick='LoadCommets($j);'>{$j}</a> ");
