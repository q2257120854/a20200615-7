...
else if($dopost=='send')
{
  ...
  //给文章评分
    ...
    if($ischeck==0)
    {
        echo '<div class="pl-list-tjfk">提交成功，审核后才会显示！</div>';
        exit();
    }
    else
    {
...
<div class="pl-list-avator"><img src="<?php echo $mface;?>" title="<?php echo $username; ?>"></div>
...
<span class="pl-list-time fl">时间：<?php echo GetDateMk($dtime); ?></span>
<span class="ok-btn fr" onclick="postBadGood('goodfb',<?php echo $id; ?>);">赞<em id='goodfb<?php echo $id; ?>'><?php if ($good == 0) $good ='';
echo $good; ?></em></span>
</div>
...
<!-- 官方回复 -->
<div class="pl-list-gfhf" <?php echo $gfhf; ?>>
