<p style='line-height:150%'><p style='line-height:150%'>版权所有 2003-2011，DedeCms.com 保留所有权利。 <br /><br />
感谢您选择织梦内容管理系统（以下简称DedeCms），DedeCms是目前国内最强大、最稳定的中小型门户网站建设解决方案之一，居于 PHP + MySQL 的技术开发，全部源码开放。DedeCms 的官方网址是： www.dedecms.com 交流论坛： bbs.dedecms.com<br /><br />
为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：<br /><br />
一、本授权协议适用且仅适用于 DedeCms 5.x.x 版本，DedeCms官方对本授权协议的最终解释权。 <br /><br />
二、协议许可的权利 <br /><br />
...
4、获得商业授权之后，您可以将本软件应用于商业用途，同时依据所购买的授权类型中确定的技术支持内容，自购买时刻起，在技术支持期限内拥有通过指定的方式获得指定范围内的技术支持服务。商业授权用户享有反映和提出意见的权力，相关意见将被作为首要考虑，但没有一定被采纳的承诺或保证。 <br /><br />
三、协议规定的约束和限制 <br /><br />
...
5、如果您未能遵守本协议的条款，您的授权将被终止，所被许可的权利将被收回，并承担相应法律责任。 <br /><br />
四、有限担保和免责声明 <br /><br />
...
协议发布时间： 2008年8月20日 By DedeCms.com</p></p>