...
$all = $dsql->GetOne("Select count(id) as c from dede_shopping where aid='$aid';");

$good = $dsql->GetOne("Select count(id) as c from dede_shopping where aid='$aid' AND ftype='good';");

//UpdateStat();

if ($type == 'all'){   echo "document.write('(".$all['c'].")');\r\n"; exit();}else{
...
$hpl=round(($good['c']/$all['c'])*100);
...

    {
        ...
        echo "document.write('100');\r\n";

    }

	else {        echo "document.write('".$hpl."');\r\n";
