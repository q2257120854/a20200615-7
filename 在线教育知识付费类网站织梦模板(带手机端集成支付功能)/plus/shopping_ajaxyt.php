...
<div class="gallery-grid clearfix" <?php echo $st; ?>>
<ul><?php
if($num >0 )echo "<li data-image=''><a href='javascript:;'><div class='thumbnail'><img src='". trim($wordcount[2][0])."'></div></a><i></i></li>";
if($num >1 )echo "<li data-image=''><a href='javascript:;'><div class='thumbnail'><img src='". trim($wordcount[2][1])."'></div></a><i></i></li>";
if($num >2 )echo "<li data-image=''><a href='javascript:;'><div class='thumbnail'><img src='". trim($wordcount[2][2])."'></div></a><i></i></li>";
if($num >3 )echo "<li data-image=''><a href='javascript:;'><div class='thumbnail'><img src='". trim($wordcount[2][3])."'></div></a><i></i></li>";
 ?>
</ul>
</div>
</div>
