...
<div class=\"comment-statistics\"><span class=\"statistics-num\">  97%  </span> 好评度 </div>
<div class=\"f-rc-list\">
<label class=\"f-radio checked\"><i class=\"icon-radio\"></i><span class=\"f-rc-text\">全部评价(102)</span></label>
...
</div><label class=\"f-radio ".($stype=='youtu' ? "checked" : "")."\" onclick='LoadShoppings(\"1\",\"youtu\");'><i class=\"icon-radio\"></i><span class=\"f-rc-text\">有图(".$youtu['dd'].")</span></label>*/
...
<div class=\"comment-statistics\"><span class=\"statistics-num\">  ".$hpl."%  </span> 好评度 </div>
<div class=\"f-rc-list\">";
...
function GetList($page=1,$stype='all')
{
	...
	if ($stype == 'youtu'){$wquery = $stype!='' ? " And imgurls like '/' " : '';}else{$wquery = $stype!='' ? " And ftype like '$stype' " : '';}
    ...
    while($fields = $dsql->GetArray('fb'))
    {
        ...
        $fields['ftypetitle'] = '<span class="pro-user-comment-commonly">一般</span>';
        if($fields['ftype']=='bad')
        {
            $fields['bgimg'] = 'cmt-bad.gif';
            $fields['ftypetitle'] = '<span class="pro-user-comment-bad">难受</span>';
        }
        else if($fields['ftype']=='good')
        {
            $fields['bgimg'] = 'cmt-good.gif';
            $fields['ftypetitle'] = '<span class="pro-user-comment-praise">超爱</span>';
        }
...
?>
<div class="y-comment-body">
<!-- 会员图像 -->
<div class="pro-comment-user">
<p class="pro-comment-user-img"><img src="<?php echo $mface;?>"></p>
<p class="pro-comment-user-name"><?php echo $username; ?></p>
</div>
<!-- 会员图像 End-->
<!-- 评论内容 -->
<div class="pro-user-comment-main">
<div class="pro-user-comment">
<div class="pro-user-h clearfix"><?php echo $ftypetitle;?>
<div class="pro-user-comment-time"><?php echo GetDateMk($dtime); ?></div>
</div>
<div class="p-b"><?php echo ubb($msg); ?></div>
</div>
<!-- 官方回复 -->
<div class="pro-admin-reply" <?php echo $gfhf; ?>> 
<dl class="clearfix"><dt>官方回复：</dt><dd><?php echo ubb($gmsg); ?></dd></dl>
</div>
<!-- 官方回复 End -->
</div>
<!-- 评论内容 End -->
...
<!-- 官方回复 -->
<div class="comment-reply" <?php echo $gfhf; ?>>
<div class="reply-item item-agency">
<div class="reply-bd">
<strong class="reply-tt">官方回复：</strong>
<p><?php echo ubb($gmsg); ?></p>
</div>
<div class="comment-ft"><span class="comment-time"><?php echo GetDateMk($gtime); ?></span></div>
</div>
</div>
<!-- 官方回复 End -->
