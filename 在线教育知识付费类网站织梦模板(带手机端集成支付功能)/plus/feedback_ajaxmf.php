...
<div class="pl-list-avator"><img width="40" height="40" src="<?php echo $row['face'];?>" title="<?php echo $username; ?>"></div>
...
<a class="ok-btn fr" href='#goodfb<?php echo $id; ?>' onclick="postBadGood('goodfb',<?php echo $id; ?>);">赞<span id='goodfb<?php echo $id; ?>'></span></a>
</div>
</div>
</li>
...
?>
<li class="pl-list clearfix">
<div class="pl-list-avator"><img width="40" height="40" src="<?php echo $mface;?>" title="<?php echo $username; ?>"></div>
<div class="pl-list-main">
<div class="pl-list-nick"><?php echo $username; ?></div>
<div class="pl-list-content"><?php echo ubb($msg); ?></div>
<div class="pl-list-btm clearfix">
<span class="pl-list-time fl">时间：<?php echo GetDateMk($dtime); ?></span>
<a class="ok-btn fr"  onclick="postBadGood('goodfb',<?php echo $id; ?>);">赞<span id='goodfb<?php echo $id; ?>'><?php if ($good == 0) $good ='';
echo $good; ?></span></a>
</div>
</div>
</li>
