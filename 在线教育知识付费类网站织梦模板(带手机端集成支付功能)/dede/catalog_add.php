...

{
    ...
    tempindex,templist,temparticle,modname,namerule,namerule2,ispart,corank,description,keywords,seotitle,moresite,siteurl,sitepath,ishidden,`cross`,`crossid`,`content`,`smalltypes`,`ico`,`typeimg01`,`typeimg02`,`typeimg03`,`kcyj`,`xszk`,`fenlei`)

    VALUES('~reid~','~topid~','~rank~','~typename~','~typedir~','$isdefault','$defaultname','$issend','$channeltype',

    '$tempindex','$templist','$temparticle','default','$namerule','$namerule2','0','0','','','~typename~','0','','','0','0','0','','','~ico~','~typeimg01~','~typeimg02~','~typeimg03~','$kcyj','$xszk','$fenlei')";
...

{
...

    {
        ...
        if((!$GLOBALS['rewrite_open'] || $GLOBALS['rewrite_open']==2) && !CreateDir($true_typedir))
    ...
    tempindex,templist,temparticle,modname,namerule,namerule2,shikan,

    ispart,corank,description,keywords,seotitle,moresite,siteurl,sitepath,ishidden,`cross`,`crossid`,`content`,`smalltypes`,`ico`,`typeimg01`,`typeimg02`,`typeimg03`,`price`,`kcyj`,`xszk`)

    VALUES('$reid','$topid','$sortrank','$typename','$typedir','$isdefault','$defaultname','$issend','$channeltype',

    '$tempindex','$templist','$temparticle','default','$namerule','$namerule2','$shikan',
