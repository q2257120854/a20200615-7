 ...
 * @version        $Id: shopping_main.php 1 19:09 2010年7月12日Z tianya $
...

{
    ...
    $query = "DELETE FROM `#@__shopping` WHERE id IN($ids) ";
...

{
    ...
    $dsql->SetQuery("SELECT ip FROM `#@__shopping` WHERE id IN ($ids) ");
...

    {
        ...
        $query = "DELETE FROM `#@__shopping` WHERE $ips ";
...

{
        ...
        $query = "UPDATE `#@__shopping` SET ischeck=1 WHERE id IN($ids) ";
...

{
    ...
    $querystring = "SELECT * FROM `#@__shopping` WHERE msg LIKE '%$keyword%' $addsql ORDER BY dtime DESC";
    ...
    $dlist->SetTemplate(DEDEADMIN.'/templets/shopping_main.htm');
