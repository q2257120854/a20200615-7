...

{
    ...
    $nurl  = "makehtml_archives_action_m.php?endid=$endid&startid=$startid&typeid=$typeid";
...

{
...

    {
          ...
          ShowMsg("生成文件：$totalnum 总用时：{$ttime} 分钟，现转向当前栏目更新&gt;&gt;","makehtml_list_action_m.php?typeid=$typeid&uptype=all&maxpagesize=50&upnext=1&isremote={$isremote}&serviterm={$serviterm}");
...

    {
...

        {
            ...
            ShowMsg("完成文档HTML更新任务，现在开始进行主页更新...","makehtml_all_m.php?action=make&step=3&uptype=$uptype&mkvalue=$mkvalue");
