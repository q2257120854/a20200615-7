...

{
    ...
    require_once(DEDEADMIN."/templets/makehtml_all_m.htm");
...

{
...

    {
        ...
        ShowMsg("完成数据优化，现在开始更新文档！","makehtml_all_m.php?action=make&step=2&uptype=$uptype&mkvalue=$mkvalue");
...

    {
        ...
        include_once(DEDEADMIN."/makehtml_archives_action_m.php");
...

    {
		...
		$homeFile = DEDEADMIN.'/'.str_replace("../", '../m/',$row['position']);
        ...
        ShowMsg("完成更新所有文档，现在开始更新栏目页！","makehtml_all_m.php?action=make&step=4&uptype=$uptype&mkvalue=$mkvalue");
...

    {
...

        {
            ...
            ShowMsg("不需要进行初处理，现更新所有栏目！", "makehtml_list_action_m.php?gotype=mkallct");
...

        {
            ...
            ShowMsg("完成栏目缓存处理，现转向更新栏目！","makehtml_list_action_m.php?gotype=mkall");
...

        {
            ...
            ShowMsg("没有可更新的栏目，现在作最后数据优化！","makehtml_all_m.php?action=make&step=10");
