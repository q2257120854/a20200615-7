...
class  Membergoodsbrowse extends BaseMember {
    ...
    public function listinfo() {
        ...
        if ($browselist) {
            $goods_list_tmp = model('goods')->getGoodsList(array('goods_id' => array('in', array_keys($browselist))), 'goods_id, goods_name, goods_image,goods_price, store_id, gc_id, gc_id_1, gc_id_2, gc_id_3');
            $goods_list = array();
