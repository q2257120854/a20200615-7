 ...
 * index
 */
$lang['store_goods_index_store_close'] = '您的机构已关闭';
...
$lang['store_goods_index_goods_limit1'] = '个，如果您想继续增加商品，请到“机构设置”升级机构等级';
$lang['store_goods_index_pic_limit'] = '您已经达到了图片空间的上限';
$lang['store_goods_index_pic_limit1'] = 'M，如果您想继续增加商品，请到“机构设置”升级机构等级';
$lang['store_goods_index_time_limit'] = '您已经达到机构使用期限，如果您想继续增加商品，请到“机构设置”升级机构等级';
...
$lang['store_goods_index_goods_price_null'] = '商品价格不能为空';
$lang['store_goods_index_store_price_null'] = '商品价格不能为空';
$lang['store_goods_index_store_price_error'] = '商品价格只能是数字';
$lang['store_goods_index_store_price_interval'] = '商品价格必须是0~9999999之间的数字';
...
$lang['store_goods_index_belong_multiple_store_class'] = '商品可以从属于机构的多个分类之下，机构分类可以由 "机构中心 -> 机构 -> 机构分类" 中自定义';
...
$lang['store_goods_index_store_price_help'] = '价格必须是0~9999999之间的数字';
...
$lang['store_goods_index_goods_select_tpl'] = '请选择要使用的售卖区域';
...
$lang['store_goods_index_goods_no'] = '机构货号';
$lang['store_goods_index_goods_no_help'] = '机构货号是指机构管理商品的编号，买家不可见<br/>最多可输入20个字符，支持输入中文、字母、数字、_、/、-和小数点';
...
$lang['store_goods_index_recommend_tip'] = '被推荐的商品会显示在机构首页';
...
$lang['store_goods_index_again_choose_category2'] = '您的机构没有绑定该分类，请重新选择分类。';
...
$lang['store_goods_step2_description_four'] = '上传商品背景图，支持jpg、gif、png格式上传，建议使用<font color="red">尺寸1000x280像素以上、大小不超过1M的长方形图片</font>';
$lang['store_goods_album_climit'] = '您上传图片数达到上限，请升级您的机构或跟管理员联系';
/**
 * 商品发布第一步
 */
...
$lang['store_goods_step3_viewed_product'] = '去机构查看商品详情';
...
$lang['store_goods_upload_pic_limit1'] = 'M，如果您想继续增加商品，请到“机构设置”升级机构等级';
...
$lang['store_goods_album_goods_bg_pic'] = '商品背景图片';
 ...
 * ajax修改商品推荐
 */
$lang['store_goods_commend_change_tip'] = '选择是否作为机构推荐商品';
...
//edit_plate
$lang['associated_layout'] = '关联版式';
$lang['top_layout'] = '顶部版式';
$lang['bottom_layout'] = '底部版式';

//store_goods_add_step1
$lang['select_category'] = '选择商品分类';
$lang['fill_item_details'] = '填写商品详情';
$lang['fill_item_information'] = '填写商品信息';

//store_goods_add_step2
...
$lang['price_instructions2'] = '价格为0则表示商品免费。';
...
$lang['minimum_stock_warning_value'] = '设置最低库存预警值。当库存低于预警值时机构中心商品列表页库存列红字提醒。';
$lang['fill_warning_number_value'] = '请填写0~255的数字，0为不预警。';
$lang['image_space_selection'] = '从图片空间选择';
$lang['close_album'] = '关闭相册';
$lang['sellergoodsadd_empty'] = '清空';
$lang['does_not_match'] = '没有符合';
$lang['search_keywords'] = '搜索关键字';
$lang['sellergoodsadd_unlimited'] = '不限';
$lang['computer_side'] = '电脑端';
$lang['mobile_side'] = '手机端';
$lang['picture_number_than'] = '图片总数得超过';
$lang['sellergoodsadd_sheet'] = '张';
$lang['words_must_not_exceed'] = '文字不得超过';
$lang['sellergoodsadd_words'] = '字';
$lang['sellergoodsadd_up'] = '上移';
$lang['sellergoodsadd_down'] = '下移';
$lang['sellergoodsadd_replace'] = '替换';
$lang['sellergoodsadd_picture'] = '图片';
$lang['sellergoodsadd_text'] = '文字';
...
$lang['sellergoodsadd_employ'] = '使用';
$lang['sellergoodsadd_unused'] = '未用';
$lang['delivery_date'] = '发货日期';
$lang['merchant_delivery_time'] = '机构发货时间';
$lang['fixed_freight'] = '固定运费';
$lang['freight_set'] = '运费设置为 0 元，前台商品将显示为免运费。';
$lang['whether_add_tax_invoice'] = '是否开增值税发票';
$lang['sellergoodsadd_make'] = '预约';
$lang['booking_information'] = '只有库存为零的商品才可以设为预约商品。机构补货后，平台自动发布消息通知已经预约的会员。';
...
$lang['upload_information4'] = '3. 每种颜色最多可上传5张图片或从图片空间中选择已有的图片，上传后的图片也将被保存在机构图片空间中以便其它使用。';
...
$lang['cancel_recommended'] = '取消推荐';

/*add_courses*/
$lang['goodscourses_name'] = '课程标题';
$lang['goodscourses_sort'] = '课程排序';
$lang['goodscourses_free'] = '是否免费';
$lang['goodscourses_url'] = '课程地址';
$lang['goodscourses_url_tip'] = '课程地址可为远程视频地址,或为本站中添加的视频地址';


//store_goods_edit_search_goods
$lang['sales_price'] = '销售价格';
$lang['add_goods'] = '添加商品';

//store_goods_list_offline
$lang['platform_article_number'] = '平台货号';
$lang['click_check_goods'] = '点击展开查看此商品全部规格；规格值过多时请横向拖动区域内的滚动条进行浏览。';
$lang['virtual_exchange'] = '虚拟兑换商品';
$lang['virtual'] = '虚拟';
$lang['f_code_priority_goods'] = 'F码优先购买商品';
$lang['advance_sale'] = '预先发售商品';
$lang['book_sales_tips'] = '预约销售提示商品';
$lang['shop_recommendation'] = '机构推荐商品';
$lang['commend'] = '荐';
$lang['details_products_mobile_phones'] = '手机端商品详情';
$lang['product_page_qr_code'] = '商品页面二维码';
$lang['download_label'] = '下载标签';

//store_goods_list_offline_waitverify
$lang['review_status'] = '审核状态';
$lang['review'] = '审核';

//store_goods_list_online
$lang['advertising'] = '设置广告词';
$lang['set_associated_layout'] = '设置关联版式';
$lang['participate_activity_operation'] = '该商品参加抢购活动期间不能进行编辑及删除等操作,可以编辑赠品和推荐组合';
$lang['lock'] = '锁定';
$lang['select_record_want_operate'] = '请选择需要操作的记录';
