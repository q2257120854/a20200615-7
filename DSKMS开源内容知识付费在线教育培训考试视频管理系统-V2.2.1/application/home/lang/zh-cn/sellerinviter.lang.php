...
$lang['goods_name'] = '商品名称';
$lang['sellerinviter_notice_1'] = '1、分销佣金基数为商品价格，不随促销优惠活动变化';
$lang['sellerinviter_notice_2'] = '2、已分销件数、已分销金额、已分销佣金数据将在佣金结算时更新';
$lang['sellerinviter_notice_3'] = '3、分销佣金会在机构的账期结算中扣除';
...
$lang['inviter_goods_id_required'] = '请选择分销商品';
$lang['inviter_ratio_1_required'] = '请填写1级分佣比例';
$lang['inviter_ratio_1_number'] = '请填写数字';
$lang['inviter_ratio_1_max'] = '1级分佣比例不能超过';
$lang['inviter_ratio_2_required'] = '请填写2级分佣比例';
$lang['inviter_ratio_2_number'] = '请填写数字';
$lang['inviter_ratio_2_max'] = '2级分佣比例不能超过';
$lang['inviter_ratio_3_required'] = '请填写3级分佣比例';
$lang['inviter_ratio_3_number'] = '请填写数字';
$lang['inviter_ratio_3_max'] = '3级分佣比例不能超过';
...
$lang['sellerinviter_goods_empty'] = '没有该分销商品';
...
$lang['inviter_add_tip'] = '请注意：平台已开启分销员返佣，分销员自己购买商品将额外再获得一份一级分销佣金';
