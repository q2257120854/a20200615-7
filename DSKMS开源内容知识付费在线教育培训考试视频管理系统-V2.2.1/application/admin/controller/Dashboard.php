...
class Dashboard extends AdminControl {
    ...
    private function _get_week_order() {
        ...
        $vrorderlist = db('vrorder')->field($field)->where($where)->group('weekval,dayofweekval')->select();
        ...
        $this->assign('stat_json_week_order', $stat_json);
    }
    ...
    private function _get_week_store() {
        ...
        $storelist = db('store')->field($field)->where($where)->group('weekval,dayofweekval')->select();
        ...
        $stat_json = getStatData_LineLabels($stat_arr);
        $this->assign('stat_json_week_store', $stat_json);
    }
    ...
    private function _get_week_goods() {
        ...
        $goodslist = db('goods')->field($field)->where($where)->group('weekval,dayofweekval')->select();
        ...
        $stat_json = getStatData_LineLabels($stat_arr);
        $this->assign('stat_json_week_goods', $stat_json);
    }
    ...
    private function _get_week_member() {
        ...
        $memberlist = db('member')->field($field)->where($where)->group('weekval,dayofweekval')->select();
        ...
        $stat_json = getStatData_LineLabels($stat_arr);
        $this->assign('stat_json_week_member', $stat_json);
    }
    ...
    public function statistics() {
        ...
        // 新增商品数
        $statistics['week_add_product'] = $goods_model->getGoodsCount(array('goods_addtime' => array('egt', $tmp_time)));
        // 等待审核
