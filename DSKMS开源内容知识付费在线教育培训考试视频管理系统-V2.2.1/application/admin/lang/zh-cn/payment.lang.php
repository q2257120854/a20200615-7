...
$lang['app_cert_path_desc'] = '（要确保证书文件可读），例如：/home/admin/cert/appCertPublicKey.crt';
$lang['alipay_cert_path'] = '支付宝公钥证书路径';
$lang['alipay_cert_path_desc'] = '（要确保证书文件可读），例如：/home/admin/cert/alipayCertPublicKey_RSA2.crt';
$lang['root_cert_path'] = '支付宝根证书路径';
$lang['root_cert_path_desc'] = '（要确保证书文件可读），例如：/home/admin/cert/alipayRootCert.crt';
$lang['private_key'] = '私钥';
...
$lang['wx_sslcert_path_desc'] = 'apiclient_cert.pem文件在服务器的路径, 如Linux系统"home/cert/apiclient_cert.pem"或window系统"d:\home\cert\apiclient_cert.pem"';
$lang['wx_sslkey_path'] = 'apiclient_key.pem路径';
$lang['wx_sslkey_path_desc'] = 'apiclient_key.pem文件在服务器的路径, 如Linux系统"home/cert/apiclient_key.pem"或window系统"d:\home\cert\apiclient_key.pem"';
