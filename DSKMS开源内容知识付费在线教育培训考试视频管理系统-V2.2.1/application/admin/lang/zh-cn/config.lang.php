...
$lang['seller_tpl'] = '机构消息模板';
$lang['seller_tpl_edit'] = '编辑机构消息模板';
...
$lang['default_store_logo'] = '默认机构标志';
...
$lang['image_dir_type_0'] = '按照文件名存放 (例:/机构id/图片)';
$lang['image_dir_type_1'] = '按照年份存放 (例:/机构id/年/图片)';
$lang['image_dir_type_2'] = '按照年月存放 (例:/机构id/年/月/图片)';
$lang['image_dir_type_3'] = '按照年月日存放 (例:/机构id/年/月/日/图片)';
$lang['image_width'] = '宽';
$lang['image_height'] = '高';
...
$lang['promotion_notice'] = '启用商品促销功能后，机构可以通过限时打折、满即送、优惠套装和推荐展位活动，对机构商品进行促销';
...
$lang['voucher_allow_notice'] = '代金券功能、积分功能、积分中心启用后，机构可以申请代金券活动；会员积分达到要求时可以在积分中心兑换代金券；<br>拥有代金券的会员可在代金券所属机构内购买商品时，选择使用而得到优惠';
...
$lang['site_phone_notice'] = '机构中心右下侧显示，方便机构遇到问题时咨询，多个请用半角逗号 "," 隔开';
...
$lang['site_email_notice'] = '机构中心右下侧显示，方便机构遇到问题时咨询';
...
$lang['setting_store_creditrule'] = '机构信用';
...
$lang['goods_verify_notice'] = '机构发布的商品是否需要通过平台的审核后才能上架';

$lang['site_logo_notice'] = '默认网站LOGO,通用头部显示，最佳显示尺寸为220*46像素';
$lang['seller_center_logo_notice'] = '机构中心LOGO，最佳显示尺寸为150*40像素，请根据背景色选择使用图片色彩';
...
$lang['order_refund_time_required'] = '申请退款有效时间为必填';


$lang['automatic_confirmation_receipt'] = '自动确认收货时间设置区间为';
$lang['exchange_code_refunded_automatically'] = '过期自动退款时间设置区间为';
$lang['numerical'] = '数值';
$lang['vod_setting'] = '视频设置';
