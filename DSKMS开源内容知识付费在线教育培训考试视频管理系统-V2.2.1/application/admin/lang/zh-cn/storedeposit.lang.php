...
$lang['admin_storedeposit_no_record']	 		= '没有符合条件的记录';
...
$lang['admin_storedeposit_withdraw_set']			= '提现设置';
...
$lang['store_withdraw_max']                             = '机构最大保证金';
$lang['store_withdraw_max_tips']			= '元';
/**
 * 提现信息编辑
 */
$lang['admin_storedeposit_cash_edit_success']		= '提现信息修改成功';
$lang['admin_storedeposit_cash_edit_fail']		= '提现信息修改失败';
$lang['admin_storedeposit_cash_edit_state']		= '修改提现单状态';
/**
 * 手动修改
 */
...
$lang['admin_storedeposit_artificial_shortprice_error']		= '金额不足,机构当前已缴保证金为';
$lang['admin_storedeposit_artificial_shortfreezeprice_error']	= '金额不足,机构当前审核保证金为';
$lang['admin_storedeposit_artificial_success']				= '修改机构保证金成功';
$lang['admin_storedeposit_artificial_fail']					= '修改机构保证金失败';
...
$lang['admin_storedeposit_artificial_operatetype_freeze']		= '审核';
$lang['admin_storedeposit_artificial_operatetype_unfreeze']		= '解冻';
/**
 * 出入明细
 */
