...
$lang['inviter_ratio_1_notice']                        ='基数为订单总商品金额，机构设置的一级分销比例不可超过此数';
$lang['inviter_ratio_2_notice']                        ='基数为订单总商品金额，机构设置的二级分销比例不可超过此数';
$lang['inviter_ratio_3_notice']                        ='基数为订单总商品金额，机构设置的三级分销比例不可超过此数';
