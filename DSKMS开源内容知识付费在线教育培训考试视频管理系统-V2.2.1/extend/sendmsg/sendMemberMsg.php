...
class sendMemberMsg
{
    ...
    public function send($param = array(),$weixin_param = array())
    {
            ...
            if(!empty($weixin_param) && $tpl_info['membermt_weixin_switch'] && $tpl_info['membermt_weixin_code']){
                ...
                $this->getMemberInfo();
                    if($this->member_info['member_wxopenid']){
                        ...
                        model('wechat')->sendMessageTemplate($this->member_info['member_wxopenid'], $tpl_info['membermt_weixin_code'], $weixin_param['url'], array_merge($tm_data,$weixin_param['data']));
                    }
            }
        }
    }
