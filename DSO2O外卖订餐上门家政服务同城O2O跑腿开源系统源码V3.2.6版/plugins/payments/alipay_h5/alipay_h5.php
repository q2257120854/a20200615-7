...
class alipay_h5 {
    ...
    public function get_payform($order_info) {
        ...
        if($order_info['order_type'] == 'real_order'){
            $url = config('h5_site_url').'/member/order_list';
        } elseif ($order_info['order_type'] == 'pd_order') {
            $url = config('h5_site_url').'/member/recharge_list';
        } elseif ($order_info['order_type'] == 'o2o_errand_order') {
            $url = config('h5_site_url').'/member/o2o_errand_order_list';
        } elseif ($order_info['order_type'] == 'o2o_fuwu_order') {
            $url = config('h5_site_url').'/member/o2o_fuwu_order_list';
        }
