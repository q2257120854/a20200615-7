...
class  FuwuOrganization extends BaseMall {
    ...
    public function index() {
        ...
        if ($class_id) {
            ...
            if($class_info){
                $condition['o2o_fuwu_class_id_1|o2o_fuwu_class_id_2|o2o_fuwu_class_id_3'] = $class_info['o2o_fuwu_class_parent_id']?$class_info['o2o_fuwu_class_parent_id']:$class_id;
        ...
        if(in_array($type,array('0','1'))){
            $condition['o2o_fuwu_organization_type']=$type;
        }
        $this->assign('o2o_fuwu_class_parent_id',$o2o_fuwu_class_parent_id);
        //查询同级的服务类别列表
        $this->assign('o2o_fuwu_class_list',model('o2o_fuwu_class')->getO2oFuwuClassList(array('o2o_fuwu_class_parent_id'=>$o2o_fuwu_class_parent_id)));
        ...
        $this->assign('o2o_fuwu_organization_list',$o2o_fuwu_organization_list);
        $this->assign('show_page', is_object($o2o_fuwu_organization_model->page_info)?$o2o_fuwu_organization_model->page_info->render():"");
    ...
    public function view(){
        ...
        $o2o_fuwu_organization_model = model('o2o_fuwu_organization');
        $condition['o2o_fuwu_organization_id'] = $organization_id;
        ...
        $this->assign('o2o_fuwu_organization_info',$o2o_fuwu_organization_info);
    ...
    public function goods(){
        ...
        $this->assign('o2o_fuwu_goods_list',$o2o_fuwu_goods_list);
        $this->assign('show_page', is_object($o2o_fuwu_goods_model->page_info)?$o2o_fuwu_goods_model->page_info->render():"");
