...
class  Memberevaluate extends BaseMember {
    ...
    public function add() {
        ...
        if (!request()->isPost()) {
            ...
            //调用逻辑层方法,PC和手机端统一使用
            $return = model('memberevaluate', 'logic')->saveorderevaluate(input('post.'), $order_info, $store_info, $order_goods, $this->member_info['member_id'], $this->member_info['member_name']);
