...
class  BaseFuwu extends BaseMall {
    ...
    public function _initialize() {
        ...
        Lang::load(APP_PATH . 'home/lang/' . config('default_lang') . '/basefuwu.lang.php');
        //卖家中心模板路径
    ...
    protected function setFuwuCurItem($curitem = '') {
        $this->assign('fuwu_item', $this->getFuwuItemList());
    ...
    protected function setFuwuCurMenu($cursubmenu = '') {
        ...
        $this->assign('fuwu_menu', $fuwu_menu);
        $curmenu = '';
    ...
    private function getFuwuMenuList() {
        ...
        if($this->o2o_fuwu_organization_info['o2o_fuwu_organization_state']==2 || $this->o2o_fuwu_organization_info['o2o_fuwu_organization_state']==3){
