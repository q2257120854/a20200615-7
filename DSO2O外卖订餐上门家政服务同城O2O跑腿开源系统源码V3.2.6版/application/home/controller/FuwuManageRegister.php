...
class FuwuManageRegister extends BaseFuwu {
    ...
    public function _initialize() {
        parent::_initialize();
        Lang::load(APP_PATH . 'home/lang/' . config('default_lang') . '/fuwu_manage_register.lang.php');
    }
    ...
    function step2() {
        if (!request()->isPost()) {
            return $this->fetch($this->template_dir . 'step2');
        } else {
    ...
    function step3() {
        if (!request()->isPost()) {
            return $this->fetch($this->template_dir . 'step3');
        } else {
            ...
            $o2o_fuwu_account_validate = validate('o2o_fuwu_account');
            ...
            $o2o_fuwu_organization_validate = validate('o2o_fuwu_organization');
            ...
            $condition['o2o_fuwu_account_name'] = $o2o_fuwu_account_data['o2o_fuwu_account_name'];
            ...
            try {
                ...
                $o2o_fuwu_account_model->rollback();
                ds_json_encode(10001, $e->getMessage());
            }
            $o2o_fuwu_account_model->commit();
        ...
        ds_json_encode(10000, lang('ds_common_op_succ').'！请去完善入驻信息');
    }
    ...
    public function check_verify_code() {
        ...
        if (!$verify_code_model->getVerifyCodeInfo(array('verify_code_type' => 2, 'verify_code_user_type' => 4, 'verify_code' => $verify_code, 'verify_code_add_time' => array('>', TIMESTAMP - VERIFY_CODE_INVALIDE_MINUTE * 60)))) {
