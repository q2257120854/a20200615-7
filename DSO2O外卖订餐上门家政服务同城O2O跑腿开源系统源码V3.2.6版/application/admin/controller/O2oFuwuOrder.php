...
class  O2oFuwuOrder extends AdminControl {
    ...
    public function change_state() {
        ...
        //获取订单详细
        $condition = array();
        $condition['o2o_fuwu_order_id'] = $order_id;
    ...
    public function show_order() {
        ...
        $this->assign('order_info', $order_info);
        $this->assign('order_goods_spec_list',model('o2o_fuwu_order_goods_spec')->getO2oFuwuOrderGoodsSpecList(array('o2o_fuwu_order_id' => $order_id)));
    ...
    public function export_step1() {
        ...
        if (!is_numeric(input('param.curpage'))) {
            ...
            $data = $order_model->getO2oFuwuOrderList($condition, '*', '', 'o2o_fuwu_order_id desc', "{$limit1},{$limit2}");
            $this->createExcel($data);
        }
    }
    ...
    private function _get_condition(){
        ...
        if (in_array($order_state, array('0', '10', '20', '30', '40'))) {
            $condition['o2o_fuwu_order_state'] = $order_state;
        }
        ...
        if ($start_unixtime || $end_unixtime) {
            $condition['o2o_fuwu_order_add_time'] = array('between', array($start_unixtime, $end_unixtime));
        }
        return $condition;
    }
