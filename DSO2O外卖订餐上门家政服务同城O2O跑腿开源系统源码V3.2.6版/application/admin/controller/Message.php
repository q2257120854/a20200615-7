...
class  Message extends AdminControl {
    ...
    public function mobile() {
        ...
        if (!(request()->isPost())) {
            ...
            $this->assign('smscf_num', $smscf_num);
            $this->assign('list_config', $list_config);
    ...
    public function mobile_testing() {
        ...
        config('smscf_type',$smscf_type);
        config('smscf_wj_username',$user_id);
        config('smscf_wj_key',$key);
        config('smscf_ali_id',$smscf_ali_id);
        config('smscf_ali_secret',$smscf_ali_secret);
        config('smscf_sign',$smscf_sign);
        $smslog_param=array(
    ...
    public function ali_tpl(){
        ...
        $mailtemplates_model = model('mailtemplates');
        $templates_list = $mailtemplates_model->getTplList(array('mailmt_code'=>array('<>','bind_email')));
        $this->assign('mstpl_list',$mstpl_list);
