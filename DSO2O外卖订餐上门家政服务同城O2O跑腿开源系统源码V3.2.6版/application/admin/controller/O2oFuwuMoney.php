...
class  O2oFuwuMoney extends AdminControl {
    ...
    public function index() {
        ...
        if (!empty($mname)) {
            $condition['o2o_fuwu_organization_name'] = array('like','%'.$mname.'%');
        }
    ...
    public function withdraw_view() {
        ...
        $o2o_fuwu_money_log_model = model('o2o_fuwu_money_log');
        $condition = array();
        $condition['o2o_fuwu_money_log_id'] = $id;
    ...
    public function adjust() {
        if (!(request()->isPost())) {
            ...
            if($o2o_fuwu_organization_id>0){
                $condition['o2o_fuwu_organization_id'] = $o2o_fuwu_organization_id;
    ...
    public function checkseller() {
        ...
        $store_info = $obj_store->getO2oFuwuOrganizationInfo(array('o2o_fuwu_organization_name' => $name));
        if (is_array($store_info) && count($store_info) > 0) {
