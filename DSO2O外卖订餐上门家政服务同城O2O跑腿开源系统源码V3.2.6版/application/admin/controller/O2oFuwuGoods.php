...
//            // 禁售
//            case 'lockup':
//                $o2o_fuwu_goods_list = $o2o_fuwu_goods_model->getO2oFuwuGoodsCommonLockUpList($where);
//                break;
//            // 等待审核
//            case 'waitverify':
//                $o2o_fuwu_goods_list = $o2o_fuwu_goods_model->getO2oFuwuGoodsCommonWaitVerifyList($where, '*', 10, 'o2o_fuwu_goods_verify desc, o2o_fuwu_goods_id desc');
//                break;
            // 全部商品
            default:
...
//        if (request()->isPost()) {
            ...
            $where = array();
            $where['o2o_fuwu_goods_id'] = array('in', $commonid_array);

            model('o2o_fuwu_goods')->editO2oFuwuGoods($update, $where);
            ds_json_encode('10000',lang('ds_common_op_succ'));
//        } else {
//            $this->assign('o2o_fuwu_goods_id', input('param.commonid'));
...
//        }
    ...
    public function goods_del() {
        ...
        $condition = array();
        $condition['o2o_fuwu_goods_id'] = array('in',$o2o_fuwu_goods_id_array);
