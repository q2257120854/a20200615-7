            ...
            'errand' => array(
                ...
                'children' => array(
                    'o2o_errand_setting' => array(
                        ...
                        'args' => 'distance_price,o2o_errand,errand',
                    ),
                    'o2o_errand_class' => array(
                        'ico'=>"&#xe728;",
                        'text' => lang('o2o_errand_class'),
                        'args' => 'index,o2o_errand_class,errand',
                    ),
                    'o2o_errand_order' => array(
                        'ico'=>'&#xe69c;',
                        'text' => lang('ds_o2o_errand_order'),
                        'args' => 'index,o2o_errand_order,errand',
                    ),
                )
            ),
            'fuwu' => array(
    ...
    function limitList() {
        $_limit = array(
            ...
            array('name' => lang('mobile'), 'child' => array(
                    array('name' => lang('mb_feedback'), 'action' => null, 'controller' => 'mbfeedback'),
