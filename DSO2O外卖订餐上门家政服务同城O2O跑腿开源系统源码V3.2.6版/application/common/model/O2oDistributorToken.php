 ...
 * 数据层模型
 */
class  O2oDistributorToken extends Model {
    ...
    public function getO2oDistributorTokenInfo($condition = array(), $fields = '*') {
        return db('O2oDistributorToken')->where($condition)->field($fields)->find();
    }
    ...
    public function addO2oDistributorToken($data) {
        return db('O2oDistributorToken')->insertGetId($data);
    }
    ...
    public function editO2oDistributorToken($data, $condition = array()) {
        return db('O2oDistributorToken')->where($condition)->update($data);
    }
    
    public function delO2oDistributorTokenInfo($condition){
        return db('O2oDistributorToken')->where($condition)->delete();
    }
