 ...
 * 数据层模型
 */
class  O2oFuwuToken extends Model {
    ...
    public function getO2oFuwuTokenInfo($condition = array(), $fields = '*') {
        return db('O2oFuwuToken')->where($condition)->field($fields)->find();
    }
    ...
    public function addO2oFuwuToken($data) {
        return db('O2oFuwuToken')->insertGetId($data);
    }
    ...
    public function editO2oFuwuToken($data, $condition = array()) {
        return db('O2oFuwuToken')->where($condition)->update($data);
    }
    
    public function delO2oFuwuTokenInfo($condition){
        return db('O2oFuwuToken')->where($condition)->delete();
    }
