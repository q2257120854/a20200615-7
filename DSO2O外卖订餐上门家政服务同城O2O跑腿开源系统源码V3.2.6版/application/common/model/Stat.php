...
class  Stat extends Model
{
    ...
    {
        if ($pagesize) {
        $res = db('member')->field($field)->where($where)->group($group)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
        $this->page_info = $res;
        return $res->items();
        } else {
            return db('member')->field($field)->where($where)->page($pagesize)->order($order)->group($group)->select();
        }
    ...
    public function getNewStoreStatList($condition, $field = '*', $pagesize = 0, $order = 'store_id desc', $limit = 0, $group = '') {
        if ($pagesize) {
            $res = db('store')->field($field)->where($condition)->group($group)->order($order)->paginate($pagesize, false, ['query' => request()->param()]);
            $this->page_info = $res;
            return $res->items();
        } else {
    ...
    {
        $res = db('member')->field($field)->where($where)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
        $this->page_info = $res;
        return $res->items();
    }
    ...
    {
        $res = db('statmember')->field($field)->where($where)->limit($limit)->order($order)->group($group)->paginate($pagesize,false,['query' => request()->param()]);
        $this->page_info = $res;
        return $res->items();
    }
    ...
    {
        if ($pagesize) {
        $res = db('pdlog')->field($field)->where($condition)->group($group)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
        $this->page_info = $res;
        return $res->items();
        } else {
    ...
    public function getBillList($condition, $type, $have_page = true)
    {
        switch ($type) {
            ...
            case 'ob'://店铺
                ...
                $result = db('orderbill')->alias('order_bill')->join('__STORE__ store', 'order_bill.ob_store_id=store.store_id', 'left')->field('order_bill.*,store.member_name')->where($condition)->order('ob_no desc')->paginate($pagesize,false,['query' => request()->param()]);
    ...
    {
        $res = db('ordergoods')->alias('ordergoods')->field($field)->join('__ORDER__ order', 'ordergoods.order_id=order.order_id', 'left')->where($where)->group($group)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
        $this->page_info = $res;
        return $res->items();
    }
    ...
    {
        $res = db('orderlog')->alias('orderlog')->field($field)->join('__ORDER__ order', 'orderlog.order_id = order.order_id', 'left')->where($where)->group($group)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
        $this->page_info = $res;
        return $res->items();
    }
    ...
    {
        if ($pagesize) {
        $res = db('refundreturn')->field($field)->where($where)->group($group)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
        $this->page_info = $res;
        return $res->items();
        } else {
    ...
    {
        $res = db('evaluatestore')->alias('evaluatestore')->field($field)->join('__STORE__ store', 'evaluatestore.seval_storeid=store.store_id', 'left')->where($where)->group($group)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
        $this->page_info = $res;
        return $res->items();
    }
    ...
    {
        $res = db('order')->field($field)->where($where)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
        $this->page_info = $res;
        return $res->items();
    }
    ...
    public function statByPointslog($where, $field = '*', $pagesize = 0, $limit = 0, $order = '', $group = '')
    {
        ...
        $res = db('pointslog')->field($field)->where($where)->group($group)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
        $this->page_info = $res;
        return $res->items();
    }
    ...
    public function statByStatordergoods($where, $field = '*', $pagesize = 0, $limit = 0, $order = '', $group = '')
    {
        ...
        if ($pagesize) {
        $res = db('statordergoods')->field($field)->where($where)->group($group)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
        $this->page_info = $res;
        return $res->items();
        } else {
    ...
    public function statByStatorder($where, $field = '*', $pagesize = 0, $limit = 0, $order = '', $group = '') {
        if ($pagesize) {
            $res = db('statorder')->field($field)->where($where)->group($group)->order($order)->paginate($pagesize, false, ['query' => request()->param()]);
            $this->page_info = $res;
            return $res->items();
        } else {
    ...
    public function statByGoods($where, $field = '*', $pagesize = 0, $limit = 0, $order = '', $group = '')
    {
        ...
        $res = db('goods')->field($field)->where($where)->group($group)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
        $this->page_info = $res;
        return $res->items();
    }
    ...
    {
		if ($pagesize) {
			$res = db($tablename)->field($field)->where($where)->group($group)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
			$this->page_info = $res;
			return $res->items();
        } else {
