...
class  O2oErrandOrder extends Validate {
    ...
    protected $rule = [
        ...
        'o2o_errand_order_distance' => 'require|number',
        ...
        'o2o_errand_order_amount' => 'require|number|min:0',
        'o2o_errand_order_distance_price' => 'require|number|min:0',
        'o2o_errand_order_weight_price' => 'number|min:0',
        'o2o_errand_order_time_price' => 'number|min:0',
        'o2o_errand_order_goods_price' => 'number|min:0',
        'o2o_errand_order_gratuity' => 'number|min:0',
        'o2o_errand_order_weight' => 'number|min:0',
    ...
    protected $message = [
        ...
        'o2o_errand_order_distance.number' => '配送距离错误',
        ...
        'o2o_errand_order_amount.number' => '订单总费用错误',
        'o2o_errand_order_amount.min' => '订单总费用错误',
        'o2o_errand_order_distance_price.require' => '缺少基础运费',
        'o2o_errand_order_distance_price.number' => '基础运费错误',
        'o2o_errand_order_distance_price.min' => '基础运费错误',
        'o2o_errand_order_weight_price.number' => '重量附加费错误',
        'o2o_errand_order_time_price.number' => '特殊时段费错误',
        'o2o_errand_order_time_price.min' => '特殊时段费错误',
        'o2o_errand_order_goods_price.number' => '预估商品价格错误',
        'o2o_errand_order_goods_price.min' => '预估商品价格错误',
        'o2o_errand_order_gratuity.number' => '小费错误',
        'o2o_errand_order_gratuity.min' => '小费错误',
        'o2o_errand_order_weight.number' => '重量错误',
