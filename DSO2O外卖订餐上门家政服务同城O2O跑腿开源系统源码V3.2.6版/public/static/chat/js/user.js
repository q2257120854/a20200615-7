...
$(function () {
    if (user['u_id'] != '') {
        ...
        var chat_user_list = '<div class="chat-box"><div class="chat-list"><div class="chat-list-top"><img class="avatar" src="'+user['avatar']+'" /><h1>'+user['u_name']+'</h1><span class="minimize-chat-list iconfont" onclick="chat_show_list();">&#xe6e6;</span></div>' +
        ...
        if (obj_friend.parent().find("dd[u_id='" + u_id + "']").size() == 0) {
            if (user_list[u_id]['online'] > 0) {
                obj_friend.before('<dd u_id="' + u_id + '" onclick="chat(' + u_id + ');"><span class="user-avatar avatar-1"><img alt="' + user_list[u_id]['u_name']
                        + '" src="' + user_list[u_id]['avatar'] + '"><i class="online"></i></span><h5>' + user_list[u_id]['u_name'] + '</h5><a class="iconfont" href="javascript:void(0)">&#xe71b;</a></dd>');
            } else {
                obj_friend.after('<dd u_id="' + u_id + '" onclick="chat(' + u_id + ');"><span class="user-avatar avatar-0"><img alt="' + user_list[u_id]['u_name']
                        + '" src="' + user_list[u_id]['avatar'] + '"><i class="offline"></i></span><h5>' + user_list[u_id]['u_name'] + '</h5><a class="iconfont" href="javascript:void(0)">&#xe71b;</a></dd>');
            }
        }
    }
    obj_friend.remove();
