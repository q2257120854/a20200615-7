...
CREATE TABLE `#__cron` (
  ...
  `type` tinyint(3) unsigned DEFAULT NULL COMMENT '任务类型 1商品上架 2根据商品id更新商品促销价格 3优惠套装过期 4推荐展位过期 7限时折扣过期',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='配送投诉表' AUTO_INCREMENT=1;
...
CREATE TABLE IF NOT EXISTS `#__o2o_distributor` (
  ...
  `o2o_distributor_errand_deposit` DECIMAL( 10, 2 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '跑腿保证金',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='配送员通知表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='配送员登录token表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__o2o_errand_class` (
  ...
  `o2o_errand_class_item` TEXT NOT NULL DEFAULT  '' COMMENT  '跑腿类别条目',
  PRIMARY KEY (`o2o_errand_class_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='跑腿类别' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__o2o_errand_order` (
  ...
  `o2o_distributor_id` int(11) unsigned NOT NULL COMMENT '配送员ID',
  `o2o_distributor_name` varchar(60) NOT NULL COMMENT '配送员名称',
  `o2o_distributor_realname` varchar(60) NOT NULL COMMENT '配送员姓名',
  ...
  `o2o_errand_order_evaluate_score` DECIMAL( 2, 1 ) UNSIGNED NOT NULL DEFAULT  '5' COMMENT  '评分',
  PRIMARY KEY (`o2o_errand_order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='跑腿订单' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='服务账号' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='服务分类' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__o2o_fuwu_goods` (
  ...
  `o2o_fuwu_goods_advword` varchar(255) NULL DEFAULT  '' COMMENT '服务商品广告词',
  ...
  `o2o_fuwu_goods_default_price` decimal(10,2) unsigned NOT NULL DEFAULT '0' COMMENT '默认价格',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='服务商品' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='服务规格' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='服务资金记录' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='服务机构通知表' AUTO_INCREMENT=1 ;
...
`o2o_fuwu_goods_spec_price` DECIMAL( 10, 2 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '服务规格价格',
  `o2o_fuwu_order_default_quantity` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '默认服务数量',
  `o2o_fuwu_order_default_amount` decimal(10,2) unsigned NOT NULL DEFAULT '0' COMMENT '默认服务价格',
  `o2o_fuwu_order_added_amount` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '增值服务价格',
  `o2o_fuwu_order_amount` decimal(10,2) unsigned NOT NULL DEFAULT '0' COMMENT '订单总价格',
...
`o2o_fuwu_order_evaluate_score` DECIMAL( 2, 1 ) UNSIGNED NOT NULL DEFAULT  '5' COMMENT  '评分',
  PRIMARY KEY (`o2o_fuwu_order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='服务订单' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='服务订单日志' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单增值服务' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__o2o_fuwu_organization` (
  ...
  `o2o_fuwu_organization_parent_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '服务机构上级ID',
  `o2o_fuwu_organization_score` decimal(2,1) unsigned NOT NULL DEFAULT '5' COMMENT '评分',
  ...
  `o2o_fuwu_organization_avaliable_money` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '可用资金',
  `o2o_fuwu_organization_freeze_money` decimal(10,2) NOT NULL DEFAULT '0' COMMENT '冻结资金',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='服务机构' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='服务机构token' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='服务上传文件' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__o2o_order_bill` (
  ...
  `o2o_order_bill_paytime` int(10) unsigned NOT NULL COMMENT '付款时间',
...
`o2o_order_bill_errand_distance_totals` DECIMAL( 10, 2 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '跑腿基础运费',
`o2o_order_bill_errand_weight_totals` DECIMAL( 10, 2 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '重量附加费',
`o2o_order_bill_errand_time_totals` DECIMAL( 10, 2 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '特殊时段费用',
`o2o_order_bill_errand_gratuity_totals` DECIMAL( 10, 2 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '跑腿小费',
  PRIMARY KEY (`o2o_order_bill_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='配送结算单表' AUTO_INCREMENT=1 ;
...
CREATE TABLE `#__order` (
  ...
  `o2o_order_distance` FLOAT( 10, 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '配送单距离',
...
CREATE TABLE `#__store` (
  ...
  `store_o2o_distance` int(10) UNSIGNED NOT NULL DEFAULT '1000' COMMENT '配送距离（米）',
  `store_o2o_fee` DECIMAL(10,2) UNSIGNED NOT NULL DEFAULT '1' COMMENT '配送单费用',
  ...
  `store_o2o_auto_deliver` INT UNSIGNED NOT NULL DEFAULT '1' COMMENT '自动派单（0否1是）',
  `store_o2o_min_cost` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '最小接单金额',
  `store_o2o_reject_time` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '拒绝接单时间（分钟）',
  `store_o2o_total_time` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '总用时（秒）',
  `store_o2o_total_count` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '总订单',
  `store_o2o_average_time` INT UNSIGNED NOT NULL DEFAULT '0' COMMENT '平均用时（分钟）',
  ...
  `store_o2o_complaint_fine` DECIMAL( 10, 2 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '投诉罚款',
...
(726, 'o2o_errand_weight_price', 'a:1:{i:0;a:7:{s:12:"start_weight";i:0;s:10:"end_weight";i:5;s:8:"if_fixed";i:1;s:5:"price";i:0;s:15:"interval_weight";i:0;s:5:"title";s:9:"0~5公斤";s:7:"content";s:4:"0元";}}', '跑腿重量附加费'),
...
(731 ,  'wechat_tm_order_pay',  '',  '微信模板消息：待处理订单通知'),
(732 ,  'wechat_tm_order_receipt',  '',  '微信模板消息：派单成功提醒'),
(733 ,  'wechat_tm_order_refund',  '',  '微信模板消息：退款审核通知'),
(740 ,  'h5_site_url',  'http://h5.dsmall.com',  '手机端地址'),
...
(4, 2, '服务轮播图', NULL, NULL, '5a460095839c8.jpg', 1514476800, 1599012800, 255, 1);
