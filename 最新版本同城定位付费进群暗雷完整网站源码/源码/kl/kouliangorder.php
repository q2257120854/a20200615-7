				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=get_klorderzongshu()?></div>
							<div class="text-muted">扣量总数量</div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=get_xiaoshu(get_klorderzongje())?></div>
							<div class="text-muted">扣量总额</div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=get_tdklorderzongshu()?></div>
							<div class="text-muted">今日扣量数</div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=get_xiaoshu(get_tdklorderzongje())?></div>
				...
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=get_ztklorderzongshu()?></div>
							<div class="text-muted">昨日扣量数</div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=get_xiaoshu(get_ztklorderzongje())?></div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">扣量订单</div>
					...
					<table  class="table table-hover">
						...
						<th   width="43"><span onClick="selectBox('reverse')">选</span></th>
							...
							<!--	<th width="131" class="sort">资源名称</th>--->
								<th width="86" class="sort">收款金额</th>
