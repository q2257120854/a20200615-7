...
<div class="layui-fluid child-body">
    <div class="layui-row">
            <div class="layui-btn-group">
                ...
                <button class="layui-btn layui-btn-sm layui-btn-normal" id="my-surl-btn"><i class="layui-icon">&#xe641;</i>获取推广链接</button>


                <button class="layui-btn layui-btn-sm layui-btn-normal" id="myerweima"><i class="layui-icon">&#xe641;</i>获取推广二维码</button>
...
table.render({
    ...
    cols: [
        [ //标题栏
            ...
            {field:'price', title: '价格',width:180 , templet: '#priceTpl'},
            {field:'pay_count', title: '打赏数',width:180},
            {field:'zt', title: '状态',width:180},
            {field:'date', title: '添加时间',width:180 },
            {fixed: 'right',title: '操作', width:378, align:'center', toolbar: '#operate'}
        ]
    ],
