...
<div class="layui-fluid child-body">
    <div class="layui-btn-group">
        <button class="layui-btn layui-btn-sm" id="add-all-btn"><i class="layui-icon">&#xe654;</i>添加全部选中链接</button>
...
<script type="text/html" id="operate">
    ...
    <a class="layui-btn layui-btn-xs" lay-event="add"><i class="layui-icon">&#xe654;</i>添加到我的链接</a>
</script>
