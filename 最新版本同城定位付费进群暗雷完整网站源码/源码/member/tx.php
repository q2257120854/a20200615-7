...
<div class="layui-fluid child-body">
    <div class="layui-row layui-col-space10">
        <div class="layui-col-md6" style="width:60%;">
            <blockquote class="layui-elem-quote1" style="position:absolute;width: 25%;">
                <h3>我的余额：</h3>
                <br>
                <h1>￥<?=get_xiaoshu($member_rmb)?></h1>
            </blockquote>
          
                <blockquote class="layui-elem-quote2" style="position:absolute;margin-left:34%;width:25%;">
                <h3>下级提成：</h3>
                <br>
            ...
            <blockquote class="layui-elem-quote3" style="margin-left:69%;width:25%;">
                <h3>我的收入：</h3>
                <br>
