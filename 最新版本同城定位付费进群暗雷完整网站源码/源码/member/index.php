...
<div class="layui-layout-body">
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            <div class="layui-logo" style="font-size: 30px;font-weight: bold;color: #ffffff;background-color: #1C2B36;"><?=$site_name?></div>
            <ul class="layui-nav layui-layout-right">
			
			
                <li class="layui-nav-item">
                    <a href="javascript:;" style="color: #000;" ><i class="layui-icon">&#xe612;</i> <?=$member_nickname?></a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="resetpw-btn">修改密码</a></dd>
                        <!-- <dd><a href="javascript:;" id="bankaccount-btn">提现银行账户</a></dd> -->
                    </dl>
                </li>
                 <li class="layui-nav-item"><a href="logout.php" style="color: #000;">退出</a></li>
            </ul>
        </div>
        <div class="layui-side layui-bg-black">
            <div class="layui-side-scroll">
                <ul class="layui-nav layui-nav-tree">
                    ...
                    <li class="layui-nav-item "><a href="shipin.php" target="iframe"><i class="layui-icon">&#xe6ed;</i>&nbsp;&nbsp;我的链接</a></li>
                    <li class="layui-nav-item "><a href="shipins.php" target="iframe"><i class="layui-icon">&#xe68e;</i>&nbsp;&nbsp;公共链接</a></li>


                   <!-- <li class="layui-nav-item "><a href="dashang.php" target="iframe"><i class="layui-icon">&#xe60a;</i>&nbsp;&nbsp;收款统计</a></li>-->
                    ...
                    <li class="layui-nav-item "><a href="txjl.php" target="iframe"><i class="layui-icon">&#xe65e;</i>&nbsp;&nbsp;提现记录</a></li>
                     ...
                     <li class="layui-nav-item "><a href="yqm.php" target="iframe"><i class="layui-icon">&#xe672;</i>&nbsp;&nbsp;下级代理</a></li>
       ...
       <?php echo base64_decode('5pCc6JmO57K+5ZOB56S+5Yy6'); echo base64_decode('d3d3LnNvdWhvLm5ldOaPkOS+m+a6kOeggQ==');?>
