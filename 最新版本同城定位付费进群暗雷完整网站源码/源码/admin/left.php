 	...
 	<li class="parent ">
			...
			<!--	<li class="parent ">
				<a  data-toggle="collapse" href="#sub-item-3">
					<span class="glyphicon glyphicon-list"></span> 群列表 <span data-toggle="collapse" href="#sub-item-3" class="icon pull-right"><em class="glyphicon glyphicon-s glyphicon-plus"></em></span> 
				</a>
				<ul class="children collapse <? if ($nav=='channel' or $nav=='detail'    ){echo 'in';}?>" id="sub-item-3">
					<li  >
						<a class="" href="channel.php">
							<span class="glyphicon glyphicon-share-alt"></span> 群分类
						</a>
					</li>
					<li>
						<a class="" href="detail.php">
							<span class="glyphicon glyphicon-share-alt"></span> 群列表
						</a>
					</li>
