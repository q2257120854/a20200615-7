				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=get_orderzongshu()?></div>
							<div class="text-muted">订单总数量</div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=get_xiaoshu(get_orderzongje())?></div>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=get_tdorderzongshu()?></div>
							<div class="text-muted">今日打赏数</div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=get_xiaoshu(get_tdorderzongje())?></div>
				...
				<div class="panel panel-teal panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=get_ztorderzongshu()?></div>
							<div class="text-muted">昨日打赏数</div>
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-md-6 col-lg-3">
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large"><?=get_xiaoshu(get_ztorderzongje())?></div>
							<div class="text-muted">昨日收入</div>
						</div>
					</div>
				</div>
			</div>
...
//-->
  ...
  if (isset($_GET['key'])) {
 $sql = 'select * from '.flag.'rmbjl where uid  = "'.$_GET['key'].'"  or   remark like "%'.$_GET['key'].'%"   and  zt = 1      order by ID desc , id desc';
 							}
							elseif (isset($_GET['uid'])) {
 $sql = 'select * from '.flag.'rmbjl where uid  =  '.$_GET['uid'].'    order by ID desc , id desc';
 							}
														elseif (isset($_GET['type'])) {
 $sql = 'select * from '.flag.'rmbjl where type  =  '.$_GET['type'].'  and  zt = 1   order by ID desc , id desc';
 							}
							
							else{
									$sql = 'select * from '.flag.'order  where zt =1  order by ID desc , id desc';
 								}
