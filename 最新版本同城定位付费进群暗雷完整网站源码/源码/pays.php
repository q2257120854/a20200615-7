...
<img id="headimg" src="/img/mm.jpg" alt="" style="height: 60.0625px;">
		<?php
			if(getCity(getIp())!='未知' ){
...
<span id="toast" style="top: 216.938px;">该群设置了付费入群<br>支付88元即可入群</span>
<a href="/url.php" id="add" style="top: 264.938px;">立即加入</a></div>
