...
<img id="headimg" src="/qun/img/mm.jpg" alt="" style="height: 60.0625px;">
		<?php
			if(getCity(getIp())!='未知' ){
				...
				echo '<h2 style="left:30px;" id="title">'.getCity(getIp()).'<span ">外围少妇大学生共享</span>'.date('',strtotime()).'</h2>';
			}else{
...
<span id="toast" style="top: 216.938px;">该群设置了付费入群<br>支付<?=$jiage?>元即可入群</span>
