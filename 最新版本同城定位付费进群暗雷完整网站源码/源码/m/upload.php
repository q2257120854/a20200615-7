...
KindEditor.ready(function(K) {
    ...
    <body>
        <section id="container">
            ...
            <div class="toptitle_box">
                <div class="conbox"><i onclick="javascript:history.go(-1);"><img src="agency/images/back.png"></i><span>链接上传</span>
                </div>
            </div>
 ...
 <input type="hidden" name="do" value="save" />
                    ...
                    <div class="m_con"><span>链接链接：</span>
                                    <input  name="url"  id="url" type="text" placeholder="请输入链接链接" autocomplete="off" class="m_text">
                                   <? if ($site_userupload==1) {?>     <button type="button" class="layui-btn" id="upload-video">上传链接</button><? }?>

                    </div>
                    
                      <div class="m_con"><span>链接封面：</span>
                                    <input id="cover-url" type="text"  name="image" placeholder="请输入链接封面图链接" autocomplete="off" class="m_text">   <? if ($site_userupload==1) {?> <button type="button" class="layui-btn" id="upload-video-cover">上传链接封面</button>
<? }?>
                    </div>
