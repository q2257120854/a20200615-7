...
function Open_win_con(shorturl) {
    ...
    str_content += "<div class=\"h_title\">我的链接</div>\n";
    str_content += "<div style=\"display: none;\" class=\"h_ewmcon\">\n";
    str_content += ewm_img + "\n";
    str_content += "</div>\n";
    str_content += "<div style=\"display: none;\" class=\"h_ewmtitle\">请用微信扫一扫</div>\n";
