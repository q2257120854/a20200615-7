...
?>
            <div class="toptitle11"><span>收款统计</span></div>			
			 <div class="h_invitedagen3">
                    <dl>
                        <dt><span>今日收款数</span></d> <dd><span><?=get_tdordernum($member_id)?></span></dd>
                    </dl>
			</div>			
			 <div class="h_invitedagen3"   >
                    <dl>
                        <dt><span>今日收入</span></dt> <dd><span><?=get_xiaoshu(get_tdorderprice($member_id))?>元</span></dd>
                    </dl>
			</div>
	 ...
	 <div class="h_invitedagen3">
                    <dl>
                        <dt><span>昨日收款数</span></d> <dd><span><?=get_ztordernum($member_id)?></span></dd>
                    </dl>
			</div>			
			 <div class="h_invitedagen3"   >
                    <dl>
                        <dt><span>昨日收入</span></dt> <dd><span><?=get_xiaoshu(get_ztorderprice($member_id))?>元</span></dd>
                    </dl>
			</div>
            ...
            <!--mid0-->
             <div class="h_invitedagent1">
                    <dl>
                         <dt><span>收款时间</span></dt>
                        <dt><span>金额</span></dt>
                        <dt><span>资源ID</span></dt>
                       </dl>
            </div>
            <div class="h_invitedagent_box">
            <?
	$sql = 'select * from '.flag.'order  where  uid  ='.$member_id.' and zt = 1 and kl = 0  order by ID desc , id desc';  								$pager = page_handle('page',20,mysql_num_rows(mysql_query($sql)));
							...
							while($row= mysql_fetch_array($result)){
									...
									?>
            <dl>
                         <dt><span><?=$row['pdate']?></span></dt> 
                        <dt><span><?=$row['payprice']?></span></dt> 
                        <dt><span><?=$row['vid']?></span></dt> 
                      </dl>
<? }?>
