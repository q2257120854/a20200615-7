...
return array(
    ...
    '13' => array('name' => '网址', 'icon' => 'xe616', 'sub' => array(

        '131' => array("show"=>1,'name' => '网址数据', 'controller' => 'website',		'action' => 'data'),
        '13101' => array("show"=>0,'name' => '--网址信息维护', 'controller' => 'website',		'action' => 'info'),
        '13102' => array("show"=>0,'name' => '--网址删除', 'controller' => 'website',		'action' => 'del'),
        '13103' => array("show"=>0,'name' => '--网址状态', 'controller' => 'website',		'action' => 'field'),

        '132' => array("show"=>1,'name' => '添加网址', 'controller' => 'website',		'action' => 'info'),
        '133' => array("show"=>1,'name' => '已锁定网址', 'controller' => 'website',		'action' => 'data','param'=>'lock=1'),
        '134' => array("show"=>1,'name' => '未审核网址', 'controller' => 'website',		'action' => 'data','param'=>'status=0'),

        '139' => array("show"=>1,'name' => '批量操作网址', 'controller' => 'website',		'action' => 'batch'),
        '1391' => array("show"=>1,'name' => '重名网址数据', 'controller' => 'website',		'action' => 'data', 'param'=>'repeat=1'),
    )),
    ...
    '12' => array('name' => 'app设置', 'icon' => 'xe62e', 'sub' => array(
        '121' => array("show"=>1,'name' => '软件参数', 'controller' => 'app',               'action' => 'config'),
        '1210' => array("show"=>1,"name" => '公告配置', 'controller' => 'app',         'action' => 'notice'),
        '1211' => array("show"=>1,"name" => '解析地址', 'controller' => 'app',          'action' => 'analysisurl'),
        '1212' => array("show"=>1,"name" => '弹窗消息', 'controller' => 'app',          'action' => 'popupmessage'),
        '1213' => array("show"=>0,"name" => '消息推送', 'controller' => 'app',          'action' => 'messagepush'),
        '122' => array("show"=>0,"name" => 'api数据', 'controller' => 'app',              'action' => 'apixx'),
        '123' => array("show"=>1,"name" => '广告管理', 'controller' => 'app',          'action' => 'advertisement'),
        '124' => array("show"=>1,"name" => '综合页面', 'controller' => 'app',           'action' => 'comprehensive'),
       

    )),
  //'14' => array('name' => '直播', 'icon' => 'xe616', 'sub' => array(

  //      '141' => array("show"=>1,'name' => '直播数据', 'controller' => 'live',		'action' => 'data'),
  //      '14101' => array("show"=>0,'name' => '--网址信息维护', 'controller' => 'live',		'action' => 'info'),
  //      '14102' => array("show"=>0,'name' => '--网址删除', 'controller' => 'live',		'action' => 'del'),
  //      '14103' => array("show"=>0,'name' => '--网址状态', 'controller' => 'live',		'action' => 'field'),

  //      '142' => array("show"=>1,'name' => '添加直播', 'controller' => 'live',		'action' => 'info'),
  //      '143' => array("show"=>1,'name' => '已锁定直播', 'controller' => 'live',		'action' => 'data','param'=>'lock=1'),
  //      '144' => array("show"=>1,'name' => '未审核直播', 'controller' => 'live',		'action' => 'data','param'=>'status=0'),

  //      '149' => array("show"=>1,'name' => '批量操作直播', 'controller' => 'live',		'action' => 'batch'),
  //      '1491' => array("show"=>1,'name' => '重名直播数据', 'controller' => 'live',		'action' => 'data', 'param'=>'repeat=1'),
  //  )),
);