<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/www/wwwroot/qy.redlk.com/application/admin/view/vod/index.html";i:1582533410;s:65:"/www/wwwroot/qy.redlk.com/application/admin/view/public/head.html";i:1582533410;s:65:"/www/wwwroot/qy.redlk.com/application/admin/view/public/foot.html";i:1582533410;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="my-toolbar-box">
        ...
        <div class="center mb10">
            <form class="layui-form " method="post">
                ...
                <div class="layui-input-inline w150">
                    <select name="plot">
                        <option value="">选择分集剧情</option>
                        <option value="0" <?php if($param['plot'] == '0'): ?>selected <?php endif; ?>>没有</option>
                        <option value="1" <?php if($param['plot'] == '1'): ?>selected <?php endif; ?>>有</option>
                    </select>
                </div>
                <div class="layui-input-inline w150">
                    <select name="order">
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td>
                    [<?php echo $vo['type']['type_name']; ?>] <a target="_blank" class="layui-badge-rim " href="<?php echo mac_url_vod_detail($vo); ?>"><?php echo htmlspecialchars($vo['vod_name']); ?></a>
                    <?php if($vo['vod_status'] == 0): ?> <span class="layui-badge">未审</span><?php endif; if($vo['vod_lock'] == 1): ?> <span class="layui-badge">锁定</span><?php endif; if($vo['vod_isend'] == 0 && $vo['vod_serial'] != ''): ?> <span class="layui-badge layui-bg-blue">连载<?php echo $vo['vod_serial']; ?></span><?php endif; if($vo['vod_remarks'] != ''): ?> <span class="layui-badge layui-bg-orange"><?php echo $vo['vod_remarks']; ?></span><?php endif; if($vo['vod_plot'] == 1): ?> <span class="layui-badge layui-bg-cyan">剧情</span><?php endif; ?>
                </td>
                ...
                <td>
                    ...
                    <a class="layui-badge-rim j-iframe" data-full="1"  data-href="<?php echo url('role/data?select=1&tab=vod&rid='.$vo['vod_id']); ?>" href="javascript:;" title="角色">角色</a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
