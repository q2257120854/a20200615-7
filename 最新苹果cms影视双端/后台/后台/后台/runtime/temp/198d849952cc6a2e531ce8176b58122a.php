<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"/www/wwwroot/qy.redlk.com/application/admin/view/role/index.html";i:1582533410;s:65:"/www/wwwroot/qy.redlk.com/application/admin/view/public/head.html";i:1582533410;s:65:"/www/wwwroot/qy.redlk.com/application/admin/view/public/foot.html";i:1582533410;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page-container p10">
    ...
    <div class="my-toolbar-box">
        ...
        <div class="layui-btn-group">
            ...
            <a data-href="<?php echo url('info'); ?>?tab=<?php echo $param['tab']; ?>&rid=<?php echo $param['rid']; ?>" data-full="1" class="layui-btn layui-btn-primary j-iframe"><i class="layui-icon">&#xe654;</i>添加</a>
            <?php endif; ?>
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td> <a target="_blank" class="layui-badge-rim " href="<?php echo mac_url_role_detail($vo); ?>"><?php echo htmlspecialchars($vo['role_name']); ?></a> <?php if($vo['role_status'] == 0): ?> <span class="layui-badge">未审</span><?php endif; if($vo['role_lock'] == 1): ?> <span class="layui-badge">锁定</span><?php endif; ?></td>
                ...
                <td>
                    <a class="layui-badge-rim j-iframe" data-full="1" data-href="<?php echo url('info?id='.$vo['role_id']); ?>" href="javascript:;" title="编辑">编辑</a>
