     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e7e4072b99df=explode(',',$maccms['search_hot']); if(is_array($_5e7e4072b99df) || $_5e7e4072b99df instanceof \think\Collection || $_5e7e4072b99df instanceof \think\Paginator): if( count($_5e7e4072b99df)==0 ) : echo "" ;else: foreach($_5e7e4072b99df as $key=>$vo): if($key < 5): ?>
      ...
      <div class="vod_row topic_row">
       <div class="pannel clearfix">
            ...
            <div class="pannel_head clearfix">
                <h2 class="title"><?php echo mac_default($conch['theme']['topic']['title'],'专题'); ?></h2>								
			</div>			
			<ul class="topiclist clearfix">
				<?php $__TAG__ = '{"num":"40","paging":"yes","half":"3","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Topic")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
