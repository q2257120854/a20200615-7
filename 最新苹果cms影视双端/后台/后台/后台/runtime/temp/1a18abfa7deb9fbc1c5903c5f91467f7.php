     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e838d1b3d792=explode(',',$maccms['search_hot']); if(is_array($_5e838d1b3d792) || $_5e838d1b3d792 instanceof \think\Collection || $_5e838d1b3d792 instanceof \think\Paginator): if( count($_5e838d1b3d792)==0 ) : echo "" ;else: foreach($_5e838d1b3d792 as $key=>$vo): if($key < 5): ?>
    ...
    <div class="pannel clearfix">
        <div class="pannel_head clearfix">
            <span class="pull_right">
                  共有<em class="mac_total"></em>个剧情数据
            </span>
            <h2 class="title"><i class="iconfont">&#xe630;</i> 分集剧情</h2>
        </div>
        <!-- 列表 -->
        <ul class="vodlist vodlist_hb clearfix">
            <?php $__TAG__ = '{"num":"30","paging":"yes","half":"3","pageurl":"plot\/index","type":"all","plot":"1","order":"desc","by":"sort","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
			<li class="vodlist_item num_<?php echo $key; ?>">
				<a class="vodlist_thumb lazyload" href="<?php echo mac_url_plot_detail($vo); ?>" data-original="<?php echo mac_url_img($vo['vod_pic']); ?>">
				...
				<div class="vodlist_titbox">									
					...
					<a href="<?php echo mac_url_plot_detail($vo); ?>" title="<?php echo $vo['vod_name']; ?>"><?php echo $vo['vod_name']; ?></a>
					</p>
