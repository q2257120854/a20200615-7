     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e81c308a8865=explode(',',$maccms['search_hot']); if(is_array($_5e81c308a8865) || $_5e81c308a8865 instanceof \think\Collection || $_5e81c308a8865 instanceof \think\Paginator): if( count($_5e81c308a8865)==0 ) : echo "" ;else: foreach($_5e81c308a8865 as $key=>$vo): if($key < 5): ?>
...
<?php endif; endif; ?>
       ...
       <div class="pannel clearfix">
        ...
        <div class="mac_msg_r">
              <form class="gbook_form gbook_font">
                ...
                <div class="msg_code">
                    <div class="remaining_w">提示：还可输入<span class="gbook_remaining remaining">200</span>字</div>
	...
	<div class="commlist_row">
     ...
     <span class="pull_right">共&nbsp;<span class="mycol"><?php echo $__PAGING__['record_total']; ?></span>&nbsp;条留言，当前第&nbsp;<span class="mycol"><?php echo $__PAGING__['page_current']; ?></span>&nbsp;页</span>
     <h2 class="title"><?php echo mac_default($conch['theme']['gbook']['title'],'留言'); ?></h2>								
</div>
<ul class="part_rows">
...
<span class="part_tips hidden_mb"><?php echo date('Y-m-d H:i',$vo['gbook_time']); ?><span class="split_line"></span><span class="mycol"><?php echo $vo['gbook_id']; ?>#</span></span>
<span class="part_tips hidden_xs"><?php echo date('Y-m-d H:i:s',$vo['gbook_time']); ?><span class="split_line"></span><span class="mycol">第<?php echo $vo['gbook_id']; ?>条</span>留言</span>
</div>
<div class="comm_cont">
...
<span class="text_line"><strong><span class="mycol">管理员: </span></strong><?php echo $vo['gbook_reply']; ?> ／ <?php echo date('H:i',$vo['gbook_reply_time']); ?></span>
</div>
</div>
<?php endif; ?>
</div>
