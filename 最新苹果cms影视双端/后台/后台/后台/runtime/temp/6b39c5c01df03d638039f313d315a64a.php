...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5e82f5adddef7=explode(',',$maccms['search_hot']); if(is_array($_5e82f5adddef7) || $_5e82f5adddef7 instanceof \think\Collection || $_5e82f5adddef7 instanceof \think\Paginator): if( count($_5e82f5adddef7)==0 ) : echo "" ;else: foreach($_5e82f5adddef7 as $key2=>$vo2): ?>
