...
$(function() {
	...
	<link rel="stylesheet" href="<?php echo $maccms['path_tpl']; ?>asset/css/hlrole.css" type="text/css" />
</head>
<body>
     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e7e86284b5c7=explode(',',$maccms['search_hot']); if(is_array($_5e7e86284b5c7) || $_5e7e86284b5c7 instanceof \think\Collection || $_5e7e86284b5c7 instanceof \think\Paginator): if( count($_5e7e86284b5c7)==0 ) : echo "" ;else: foreach($_5e7e86284b5c7 as $key=>$vo): if($key < 5): ?>
					...
					<div class="row tit_up">
						<div class="pannel">
							<div class="pannel_head clearfix">
								<h2 class="title"><i class="iconfont">&#xe654;</i>角色演员</h2>
								
								<span class="text_muted pull_right"><a class="text_muted pull_left" href="<?php echo mac_url('role/show'); ?>">更多<i class="iconfont more_i">&#xe623;</i></a></span>
							</div>
							<?php $__TAG__ = '{"num":"60","paging":"yes","pageurl":"role\/show","id":"v2","order":"desc","by":"time","level":"3","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v2): $mod = ($key % 2 );++$key;?>
							<div class="rank_hom list_scroll">
								<!-- 排行榜列表 -->
								<div class="rank_info">
									<div class="list_info">
										<div class="pannel_head clearfix">
											<h3 class="title">《<?php echo $v2['vod_name']; ?>》&nbsp;演员表</h3>
										<ul class="part_rows">
											<?php $__TAG__ = '{"num":"3","rid":"'.$v2['vod_id'].'","order":"asc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Role")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
                                            <li class="ranklist_items">
    <a title="<?php echo $vo['role_actor']; ?>&nbsp;饰&nbsp;<?php echo $vo['role_name']; ?>" href="<?php echo mac_url_role_detail($vo); ?>">
	<div class="ranklist_img">
		 <div class="ranklist_thumb lazyload" data-original="<?php echo mac_url_img($vo['role_pic']); ?>">						
			<span class="play hidden_xs"></span>
            <span class="part_nums part_num<?php echo $key; ?>"><?php echo $key; ?></span>

            <span class="pic_text"><?php echo $vo['role_name']; ?></span>
