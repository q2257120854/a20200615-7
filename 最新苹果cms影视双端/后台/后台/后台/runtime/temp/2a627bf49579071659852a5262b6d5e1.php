<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:40:"template/default_pc/html/vod/detail.html";i:1582533410;s:70:"/www/wwwroot/qy.redlk.com/template/default_pc/html/public/include.html";i:1582533410;s:67:"/www/wwwroot/qy.redlk.com/template/default_pc/html/public/head.html";i:1582533410;s:68:"/www/wwwroot/qy.redlk.com/template/default_pc/html/public/star2.html";i:1582533410;s:67:"/www/wwwroot/qy.redlk.com/template/default_pc/html/public/foot.html";i:1582533410;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5e82ea5bcffcc=explode(',',$maccms['search_hot']); if(is_array($_5e82ea5bcffcc) || $_5e82ea5bcffcc instanceof \think\Collection || $_5e82ea5bcffcc instanceof \think\Paginator): if( count($_5e82ea5bcffcc)==0 ) : echo "" ;else: foreach($_5e82ea5bcffcc as $key2=>$vo2): ?>
...
<div class="ui-box marg" id="playlist_<?php echo $key; ?>">
    ...
    <div class="video_list fn-clear">
        ...
        <a href="<?php echo mac_url_vod_play($obj,['sid'=>$vo['sid'],'nid'=>$vo2['nid']]); ?>" target="<?php echo $vo['player_info']['target']; ?>" ><?php echo $vo2['name']; ?></a>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</div>
<?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="ui-box marg" id="juqing" >
    <div class="ui-title">
        <h3>剧情介绍 <?php if($obj['vod_plot'] == 1): ?><a href="<?php echo mac_url_vod_plot($obj); ?>">[查看分集剧情]</a><?php endif; ?></h3>
    </div>
    <div class="tjuqing">
