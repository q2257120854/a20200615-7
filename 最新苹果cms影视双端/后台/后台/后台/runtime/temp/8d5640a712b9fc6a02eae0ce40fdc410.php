<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"/www/wwwroot/qy.redlk.com/application/admin/view/vod/info.html";i:1582533410;s:65:"/www/wwwroot/qy.redlk.com/application/admin/view/public/head.html";i:1582533410;s:67:"/www/wwwroot/qy.redlk.com/application/admin/view/public/editor.html";i:1582533410;s:65:"/www/wwwroot/qy.redlk.com/application/admin/view/public/foot.html";i:1582533410;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item">
                    <div id="plot_list" class="contents">
                        <?php if(is_array($vod_plot_list) || $vod_plot_list instanceof \think\Collection || $vod_plot_list instanceof \think\Paginator): $i = 0; $__LIST__ = $vod_plot_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <div class="layui-form-item" data-i="<?php echo $key; ?>">
                            <label class="layui-form-label">剧情<?php echo $key; ?>：</label>
                            <div class="layui-input-inline w500"><input type="text" name="vod_plot_name[]" class="layui-input" value="<?php echo $vo['name']; ?>" placeholder="剧情标题"></div>
                            <div class="layui-input-inline w400 p10"><a href="javascript:void(0)" class="j-editor-clear">清空</a>&nbsp;<a href="javascript:void(0)" class="j-editor-remove">删除</a>&nbsp;<a href="javascript:void(0)" class="j-editor-up">上移</a>&nbsp;<a href="javascript:void(0)" class="j-editor-down">下移</a><br></div>
                            <div class="p10 m20"> </div>
                            <div class="layui-input-block "><textarea id="vod_plot_detail<?php echo $key; ?>" name="vod_plot_detail[]" type="text/plain" style="width:100%;height:150px"><?php echo mac_str_correct($vo['detail'],'#',chr(13)); ?></textarea></div>
                        </div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                    <div class="layui-form-item">
                        <label class=""><button class="layui-btn radius j-plot-add" type="button">添加一集剧情</button></label>
                        <div class="layui-input-block">
...
<script type="text/javascript">
    ...
    layui.use(['form','upload', 'layer'], function () {
        ...
        $('.j-plot-add').on('click',function(){
            plot_arr_len++;
            var tpl='<div class="layui-form-item" data-i="'+plot_arr_len+'"><label class="layui-form-label">剧情'+(plot_arr_len)+'：</label><div class="layui-input-inline w500"><input type="text" name="vod_plot_name[]" class="layui-input" placeholder="剧情标题"></div><div class="layui-input-inline w400 p10"><a href="javascript:void(0)" class="j-editor-clear">清空</a>&nbsp;<a href="javascript:void(0)" class="j-editor-remove">删除</a>&nbsp;<a href="javascript:void(0)" class="j-editor-up">上移</a>&nbsp;<a href="javascript:void(0)" class="j-editor-down">下移</a>&nbsp;</div><div class="p10 m20"></div><div class="layui-input-block"><textarea id="vod_content'+(plot_arr_len)+'" name="vod_plot_detail[]" class="layui-textarea" style="width:99%;height:250px"></textarea></div></div>';
