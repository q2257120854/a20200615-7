<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/www/wwwroot/qy.redlk.com/application/admin/view/type/info.html";i:1584259910;s:65:"/www/wwwroot/qy.redlk.com/application/admin/view/public/head.html";i:1582533410;s:65:"/www/wwwroot/qy.redlk.com/application/admin/view/public/foot.html";i:1582533410;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form layui-form-pane" method="post" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline ">
                    <select id="type_mid" name="type_mid" lay-filter="type_mid">
                        <option value="1" <?php if($info['type_mid'] == '1' || ($info['type_id'] == 0 && $infop['type_mid'] == '1')): ?>selected <?php endif; ?>>视频</option>
                        <option value="2" <?php if($info['type_mid'] == '2' || ($info['type_id'] == 0 && $infop['type_mid'] == '2')): ?>selected <?php endif; ?>>文章</option>
                      <option value="12" <?php if($info['type_mid'] == '12' || ($info['type_id'] == 0 && $infop['type_mid'] == '12')): ?>selected <?php endif; ?>>直播</option>
                        <option value="8" <?php if($info['type_mid'] == '8' || ($info['type_id'] == 0 && $infop['type_mid'] == '8')): ?>selected <?php endif; ?>>演员</option>
                        <option value="11" <?php if($info['type_mid'] == '11' || ($info['type_id'] == 0 && $infop['type_mid'] == '11')): ?>selected <?php endif; ?>>网址</option>
                    </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline w600">
                <input type="text" name="type_logo" placeholder="图片地址或路径" value="<?php echo $info['type_logo']; ?>" class="layui-input upload-input">
            </div>
            <div class="layui-input-inline ">
                <button type="button" class="layui-btn layui-upload" lay-data="{data:{thumb:0,thumb_class:'type_logo'}}" id="upload1">上传图片</button>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">分类封面：</label>
            <div class="layui-input-inline w600">
                <input type="text" name="type_pic" placeholder="图片地址或路径" value="<?php echo $info['type_pic']; ?>" class="layui-input upload-input">
            </div>
            <div class="layui-input-inline ">
                <button type="button" class="layui-btn layui-upload" lay-data="{data:{thumb:0,thumb_class:'type_pic'}}" id="upload1">上传图片</button>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item vod-list" <?php if($info['type_mid'] != '1'): ?> style="display:none" <?php endif; ?>>
            <label class="layui-form-label">扩展演员：</label>
            <div class="layui-input-block">
