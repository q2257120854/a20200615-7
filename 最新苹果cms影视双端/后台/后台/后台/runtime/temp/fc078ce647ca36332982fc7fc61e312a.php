...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5e83059c4fc96=explode(',',$maccms['search_hot']); if(is_array($_5e83059c4fc96) || $_5e83059c4fc96 instanceof \think\Collection || $_5e83059c4fc96 instanceof \think\Paginator): if( count($_5e83059c4fc96)==0 ) : echo "" ;else: foreach($_5e83059c4fc96 as $key2=>$vo2): ?>
    ...
    <ul class="directory-list">
        <li>
            <dl class="leixing">
                ...
                <?php if(empty($obj['type_extend']['class']) || (($obj['type_extend']['class'] instanceof \think\Collection || $obj['type_extend']['class'] instanceof \think\Paginator ) && $obj['type_extend']['class']->isEmpty())): $_5e83059c4fc00=explode(',',$obj['parent']['type_extend']['class']); if(is_array($_5e83059c4fc00) || $_5e83059c4fc00 instanceof \think\Collection || $_5e83059c4fc00 instanceof \think\Paginator): if( count($_5e83059c4fc00)==0 ) : echo "" ;else: foreach($_5e83059c4fc00 as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_5e83059c4fbee=explode(',',$obj['type_extend']['class']); if(is_array($_5e83059c4fbee) || $_5e83059c4fbee instanceof \think\Collection || $_5e83059c4fbee instanceof \think\Paginator): if( count($_5e83059c4fbee)==0 ) : echo "" ;else: foreach($_5e83059c4fbee as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
        ...
        <li>
            <dl class="area">
                ...
                <?php if(empty($obj['type_extend']['area']) || (($obj['type_extend']['area'] instanceof \think\Collection || $obj['type_extend']['area'] instanceof \think\Paginator ) && $obj['type_extend']['area']->isEmpty())): $_5e83059c4fbbb=explode(',',$obj['parent']['type_extend']['area']); if(is_array($_5e83059c4fbbb) || $_5e83059c4fbbb instanceof \think\Collection || $_5e83059c4fbbb instanceof \think\Paginator): if( count($_5e83059c4fbbb)==0 ) : echo "" ;else: foreach($_5e83059c4fbbb as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_5e83059c4fbaa=explode(',',$obj['type_extend']['area']); if(is_array($_5e83059c4fbaa) || $_5e83059c4fbaa instanceof \think\Collection || $_5e83059c4fbaa instanceof \think\Paginator): if( count($_5e83059c4fbaa)==0 ) : echo "" ;else: foreach($_5e83059c4fbaa as $key=>$vo): ?>
        ...
        <li>
            <dl>
                ...
                <?php if(empty($obj['type_extend']['year']) || (($obj['type_extend']['year'] instanceof \think\Collection || $obj['type_extend']['year'] instanceof \think\Paginator ) && $obj['type_extend']['year']->isEmpty())): $_5e83059c4fb81=explode(',',$obj['parent']['type_extend']['year']); if(is_array($_5e83059c4fb81) || $_5e83059c4fb81 instanceof \think\Collection || $_5e83059c4fb81 instanceof \think\Paginator): if( count($_5e83059c4fb81)==0 ) : echo "" ;else: foreach($_5e83059c4fb81 as $key=>$vo): ?>
                    <dd><a href="<?php echo mac_url_type($obj,['class'=>$vo],'show'); ?>"><?php echo $vo; ?></a></dd>
                    <?php endforeach; endif; else: echo "" ;endif; else: $_5e83059c4fb6c=explode(',',$obj['type_extend']['year']); if(is_array($_5e83059c4fb6c) || $_5e83059c4fb6c instanceof \think\Collection || $_5e83059c4fb6c instanceof \think\Paginator): if( count($_5e83059c4fb6c)==0 ) : echo "" ;else: foreach($_5e83059c4fb6c as $key=>$vo): ?>
