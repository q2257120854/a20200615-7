...
<div id="topic_page">
  ...
  <div class="all_menu_inner">
     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e7ef6e9e0ec4=explode(',',$maccms['search_hot']); if(is_array($_5e7ef6e9e0ec4) || $_5e7ef6e9e0ec4 instanceof \think\Collection || $_5e7ef6e9e0ec4 instanceof \think\Paginator): if( count($_5e7ef6e9e0ec4)==0 ) : echo "" ;else: foreach($_5e7ef6e9e0ec4 as $key=>$vo): if($key < 5): ?>
    ...
    <div class="hot_banner ">
        <div class="bgi_box">
    	<span class="bgi" style="background-image:url(<?php echo mac_url_img($obj['topic_pic']); ?>);"></span>
    	<span class="bgfd"></span>
    </div>
         <div class="hot_list">
           <div class="topic_fm">
	             <div class="topiclist_con">
		            <span class="topiclist_thumb lazyload" title="<?php echo $obj['topic_name']; ?>" data-original="<?php echo mac_url_img($obj['topic_pic']); ?>">						
	                </span>											
                 </div>
				<div class="topiclist_text">
					<h3 class="title"><?php echo $obj['topic_name']; ?></h3>
					<div class="tpcon_box"><p><?php echo $obj['topic_content']; ?></p></div>
				</div>
		   </div>
         </div>
    </div>
      ...
      <div class="vod_row">
       <div class="pannel clearfix">
            ...
            <div class="pannel_head clearfix">
                <h3 class="title">本专题共收录<strong class="mycol"><?php echo count($obj['vod_list']); ?></strong>部影片</h3>
            </div>			
			<ul class="vodlist vodlist_wi clearfix">
				<?php if(is_array($obj['vod_list']) || $obj['vod_list'] instanceof \think\Collection || $obj['vod_list'] instanceof \think\Paginator): if( count($obj['vod_list'])==0 ) : echo "" ;else: foreach($obj['vod_list'] as $key=>$vo): if(in_array(($vo['type_id']), is_array($conch['theme']['type']['hb'])?$conch['theme']['type']['hb']:explode(',',$conch['theme']['type']['hb']))): ?>
