<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/www/wwwroot/qy.redlk.com/application/admin/view/app/advertisement.html";i:1585194247;s:65:"/www/wwwroot/qy.redlk.com/application/admin/view/public/head.html";i:1582533410;s:65:"/www/wwwroot/qy.redlk.com/application/admin/view/public/foot.html";i:1582533410;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page-container p10">
    ...
    <div class="my-toolbar-box">
        ...
        <div class="layui-btn-group">
            <a data-href="<?php echo url('advertisement_add'); ?>" data-full="1" class="layui-btn layui-btn-primary j-iframe"><i class="layui-icon">&#xe654;</i>添加</a>
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td>
                    <a class="layui-badge-rim j-iframe" data-full="1" data-href="<?php echo url('adv_info?id='.$vo['id']); ?>" href="javascript:;" title="编辑">编辑</a>
                    <a class="layui-badge-rim j-tr-del" data-href="<?php echo url('adv_del?id='.$vo['id']); ?>" href="javascript:;" title="删除">删除</a>
                </td>
            </tr>
