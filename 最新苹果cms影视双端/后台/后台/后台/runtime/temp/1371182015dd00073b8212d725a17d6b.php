<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"/www/wwwroot/qy.redlk.com/application/admin/view/system/config.html";i:1582533410;s:65:"/www/wwwroot/qy.redlk.com/application/admin/view/public/head.html";i:1582533410;s:65:"/www/wwwroot/qy.redlk.com/application/admin/view/public/foot.html";i:1582533410;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-tab" lay-filter="tb1">
            <ul class="layui-tab-title">
                ...
                <li lay-id="config_2">性能优化</li>
                <li lay-id="config_3">预留参数</li>
            </ul>
            <div class="layui-tab-content">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="radio" name="app[browser_junmp]" value="0" title="关闭" <?php if($config['app']['browser_junmp'] == 0): ?>checked <?php endif; ?>>
                        <input type="radio" name="app[browser_junmp]" value="1" title="开启" <?php if($config['app']['browser_junmp'] == 1): ?>checked <?php endif; ?>>
                    </div>
