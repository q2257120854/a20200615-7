<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"template/default_pc/html/index/index.html";i:1582533410;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="markdown-body" style="padding:40px;">
    ...
    <blockquote>
        <p>
            进入专题首页：<a target="_blank" href="<?php echo mac_url('topic/index'); ?>"><?php echo mac_url('topic/index'); ?></a><br>
        </p>
    </blockquote>
    ...
    <blockquote>
        <p>
            进入留言本首页：<a target="_blank" href="<?php echo mac_url('gbook/index'); ?>"><?php echo mac_url('gbook/index'); ?></a><br>
        </p>
    </blockquote>
    ...
    <blockquote>
        <p>
            进入评论首页：<a target="_blank" href="<?php echo mac_url('comment/index'); ?>"><?php echo mac_url('comment/index'); ?></a><br>
        </p>
    </blockquote>
    ...
    <blockquote>
        <p>
            进入文章首页： <a target="_blank" href="<?php echo mac_url('art/index'); ?>"><?php echo mac_url('art/index'); ?></a><br>
        </p>
    </blockquote>
    ...
    <blockquote>
        <p>
            进入网址导航首页： <a target="_blank" href="<?php echo mac_url('website/index'); ?>"><?php echo mac_url('website/index'); ?></a><br>
        </p>
    </blockquote>
    ...
    <blockquote>
        <p>
            进入视频首页： <a target="_blank" href="<?php echo mac_url('vod/index'); ?>"><?php echo mac_url('vod/index'); ?></a><br>
        </p>
    </blockquote>
    ...
    <blockquote>
        <p>
            进入明星首页： <a target="_blank" href="<?php echo mac_url('actor/index'); ?>"><?php echo mac_url('actor/index'); ?></a><br>
        </p>
    </blockquote>
    ...
    <blockquote>
        <p>
            进入角色首页： <a target="_blank" href="<?php echo mac_url('role/index'); ?>"><?php echo mac_url('role/index'); ?></a><br>
        </p>
    </blockquote>
    ...
    <blockquote>
        <p>
            进入剧情首页： <a target="_blank" href="<?php echo mac_url('plot/index'); ?>"><?php echo mac_url('plot/index'); ?></a><br>
        </p>
    </blockquote>
