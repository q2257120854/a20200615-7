...
<div id="topnav" class="head_box">
  ...
  <div class="all_menu_inner">
     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e7e4165d1c04=explode(',',$maccms['search_hot']); if(is_array($_5e7e4165d1c04) || $_5e7e4165d1c04 instanceof \think\Collection || $_5e7e4165d1c04 instanceof \think\Paginator): if( count($_5e7e4165d1c04)==0 ) : echo "" ;else: foreach($_5e7e4165d1c04 as $key=>$vo): if($key < 5): ?>
    ...
    <!--评论开始-->
<div class="mac_comment comm_list">
<ul class="part_rows">
