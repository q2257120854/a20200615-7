...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5e7e04e26caaf=explode(',',$maccms['search_hot']); if(is_array($_5e7e04e26caaf) || $_5e7e04e26caaf instanceof \think\Collection || $_5e7e04e26caaf instanceof \think\Paginator): if( count($_5e7e04e26caaf)==0 ) : echo "" ;else: foreach($_5e7e04e26caaf as $key2=>$vo2): ?>
