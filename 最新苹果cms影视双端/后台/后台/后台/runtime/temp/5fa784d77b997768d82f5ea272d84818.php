     ...
     <!-- 分类end -->
			...
			<div class="head_hot_search hidden_xs">
				<ul class="pops_list">
					...
					<?php $_5e82a2ee6662a=explode(',',$maccms['search_hot']); if(is_array($_5e82a2ee6662a) || $_5e82a2ee6662a instanceof \think\Collection || $_5e82a2ee6662a instanceof \think\Paginator): if( count($_5e82a2ee6662a)==0 ) : echo "" ;else: foreach($_5e82a2ee6662a as $key=>$vo): if($key < 5): ?>
