...
<head>
  ...
  <meta name="keywords" content="O泡易支付系统,免签支付接口">
  <meta name="description" content="O泡易支付系统专为行业各大程序系统，提供优质的支付集成一键对接！">
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            &copy; 2020 <a href="./" class="font-weight-bold ml-1" target="_blank">O泡易支付系统</a>
          </div>
        </div>
        <div class="col-xl-6">
          <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            ...
            <li class="nav-item">
              <a href="https://www.sd20.cn" class="nav-link" target="_blank">KuCat</a>
            </li>
          </ul>
        </div>
      </div>
