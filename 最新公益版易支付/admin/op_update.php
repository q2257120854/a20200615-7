...
if($_SESSION['connet']!=true){
	if(file_get_contents('http://www.soku.cc/')){//服务器系统
...
<a id="color_href" href="http://wpa.qq.com/msgrd?v=3&uin=287158806&site=qq&menu=yes">点我联系授权</a></div></div></div></div></div>
 <div class="col-xl-6">
          <div class="card">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
			   ...
			   <tbody>
			    <tr><th scope="row">O泡授权服务器：</th><td>连接正常</td><td><a href="http://www.xsq6.com/"><font color="green">查看</font></a></td></tr>
			    <tr><th scope="row">O泡主控服务器：</th><td>连接正常</td><td><a href="http://www.xsq6.com/"><font color="green">查看</font></a></td></tr>
			   </tbody>
              </table>
            </div>
          </div>
