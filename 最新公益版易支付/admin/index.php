          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">收入详情</h3>
                </div>
                <div class="col text-right">
                  <a href="#!" class="btn btn-sm btn-<?php echo $conf['adminmb_ys']?>">￥人民币</a>
                </div>
              </div>
            </div>
       ...
       <div class="col-xl-12">
	    <div class="card-wrapper">
          <div class="card">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush"><thead class="thead-light"><tr><th sccye="col">名称</th><th sccye="col">星级</th><th sccye="col">描述</th><th sccye="col">操作</th></tr></thead>
			  <tbody><tr>
<td>森度易支付</td>
<td><span class="label label-danger">⭐⭐⭐⭐⭐</span></td>
<td>三网稳定奔放-限时免费注册</td>
<td><a target="_blank" href="https://www.soku.cc" class="label label-warning">查看详细</a></td>
</tr></tbody>
              </table>
            </div>
          </div>
