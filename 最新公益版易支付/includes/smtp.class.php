...
/* SMTP Class
 * Example:
 * $x = new SMTP('smtp.exmail.qq.com',25,true,'2791646444@qq.com','*************');
 * $x->send('God.2791646444 <mail@aswlcm.cn>','Cy <2791646444@qq.com>','f','fff');
 */
...
class SMTP {
    ...
    public function send($to, $from, $subject = "", $body = "", $fromname = "酷猫网络工作室", $reply = '', $cc = "", $bcc = "", $additional_headers = "") {
        if (empty($reply)) {
            $reply = $from;
        }
        $header = "";
