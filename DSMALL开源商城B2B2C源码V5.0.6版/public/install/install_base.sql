...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='可编辑页面表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='可编辑页面配置表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `#__editable_page_model` (
  ...
  `editable_page_path` text NOT NULL COMMENT 'index/index商场首页store/index店铺首页special/index专题活动页，多个用|分隔，空表示通用',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='可编辑页面模块表' AUTO_INCREMENT=1 ;
...
CREATE TABLE `#__ordergoods` (
  ...
  `goods_type` enum('1','2','3','4','5','6','7','8') NOT NULL DEFAULT '1' COMMENT '1默认2抢购商品3限时折扣商品4组合套装5赠品6拼团7会员等级折扣8砍价',
...
CREATE TABLE `#__payment` (
  ...
  CREATE TABLE `#__pbargain` (
  `bargain_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '砍价活动自增ID',
  `member_id` int(11) unsigned NOT NULL COMMENT '卖家用户ID',
  `member_name` varchar(50) NOT NULL COMMENT '卖家用户名',
  `store_name` varchar(50) NOT NULL COMMENT '店铺名称',
  `store_id` int(11) unsigned NOT NULL COMMENT '店铺ID',
  `bargainquota_id` int(10) unsigned NOT NULL COMMENT '砍价套餐ID',
  ...
  `bargain_goods_image` varchar(100) DEFAULT NULL DEFAULT '' COMMENT '商品图片',
...
CREATE TABLE `#__statordergoods` (
  ...
  `goods_image` varchar(100) DEFAULT NULL COMMENT '商品图片',
  `goods_pay_price` decimal(10,2) unsigned NOT NULL COMMENT '商品实际成交价',
  `goods_type` enum('1','2','3','4','5','6','7','8') NOT NULL DEFAULT '1' COMMENT '1:默认 2:抢购商品 3:限时折扣商品 4:优惠套装 5:赠品 6:拼团 7:会员等级折扣 8:砍价',
  `promotions_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '促销活动ID（抢购ID/限时折扣ID/优惠套装ID）与goods_type搭配使用',
  `commis_rate` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '佣金比例',
...
CREATE TABLE `#__vrgroupbuyclass` (
  ...
  `vrgclass_sort` tinyint(3) unsigned DEFAULT NULL DEFAULT '255' COMMENT '虚拟抢购分类排序',
...
(720 ,  'wechat_tm_order_pay',  '',  '微信模板消息：订单待发货提醒'),
(721 ,  'wechat_tm_order_send',  '',  '微信模板消息：订单发货通知'),
(722 ,  'wechat_tm_order_refund',  '',  '微信模板消息：退款审核通知'),
(730 ,  'h5_site_url',  'http://h5.dsmall.com',  '手机端地址'),
...
INSERT INTO `#__editable_page_model` (`editable_page_model_id`, `editable_page_model_name`, `editable_page_model_intro`, `editable_page_path`, `editable_page_theme`, `editable_page_model_client`, `editable_page_model_content`) VALUES
(1, '轮播图', '', '', '', '', '{"width":"100%","height":"300px","back_color":"unset","margin_top":"0","margin_bottom":"0","image":[{"count":1,"list":[]}],"link":[{"count":1,"list":[]}]}'),
(2, '富文本', '', '', '', '', '{"width":"1200px","height":"300px","back_color":"unset","margin_top":"0","margin_bottom":"0","editor":[""]}'),
(3, '三列商品', '', '', '', 'pc', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","goods":[{"gc_id":0,"sort":"new","if_fix":0,"count":3,"goods_id":[]}]}'),
(4, '一个商品', '大图尺寸1200*450px', '', '', 'pc', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","image":[{"count":1,"list":[]}],"goods":[{"gc_id":0,"sort":"new","if_fix":0,"count":1,"goods_id":[]}]}'),
(5, '两列商品', '', '', '', 'pc', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","goods":[{"gc_id":0,"sort":"new","if_fix":0,"count":2,"goods_id":[]}]}'),
(6, '两列商品', '', '', '', 'h5', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","text":[{"count":1,"list":[]}],"goods":[{"gc_id":0,"sort":"new","if_fix":0,"count":2,"goods_id":[]}]}'),
(7, '一个商品', '', '', '', 'pc', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","goods":[{"gc_id":0,"sort":"new","if_fix":0,"count":1,"goods_id":[]}]}'),
(8, '商品分类和轮播图', '分类小图标尺寸26*26px，轮播图800*400px，右下广告图188*245px', '', '', 'pc', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","image":{"0":{"count":5,"list":[]},"1":{"count":3,"list":[]},"4":{"count":1,"list":[]}},"cate":[{"gc_id":0,"list":[]}],"link":{"1":{"count":3,"list":[]},"3":{"count":3,"list":[]},"4":{"count":1,"list":[]}},"text":{"2":{"count":2,"list":[]},"3":{"count":3,"list":[]}}}'),
(9, '分类商品列表', '左侧产品分类背景图尺寸200*300px，中间广告图600*300px，右侧广告图400*300px', '', '', 'pc', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","image":[{"count":1,"list":[]},{"count":1,"list":[]},{"count":1,"list":[]}],"cate":[{"gc_id":0,"list":[]}],"link":{"1":{"count":1,"list":[]},"2":{"count":1,"list":[]}},"text":[{"count":2,"list":[]}],"goods":{"3":{"count":6,"gc_id":0,"sort":"new","if_fix":0,"goods_id":[]}},"brand":{"4":{"count":10,"gc_id":0,"if_fix":0,"brand_id":[]}}}'),
(10, '两列分类商品列表', '左侧产品分类背景图尺寸200*300px，右侧广告图395*300px', '', '', 'pc', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","image":{"0":{"count":1,"list":[]},"1":{"count":1,"list":[]},"5":{"count":1,"list":[]},"6":{"count":1,"list":[]}},"cate":{"0":{"gc_id":0,"list":[]},"5":{"gc_id":0,"list":[]}},"link":{"1":{"count":1,"list":[]},"6":{"count":1,"list":[]}},"text":{"0":{"count":2,"list":[]},"5":{"count":2,"list":[]}},"goods":{"3":{"count":3,"gc_id":0,"sort":"new","if_fix":0,"goods_id":[]},"7":{"count":3,"gc_id":0,"sort":"new","if_fix":0,"goods_id":[]}},"brand":{"4":{"count":5,"gc_id":0,"if_fix":0,"brand_id":[]},"8":{"count":5,"gc_id":0,"if_fix":0,"brand_id":[]}}}'),
(11, '分类切换商品列表', '分类图标尺寸90*90px，上下结构，上部分为初始状态图标，下部分为活动状态图标', '', '', 'pc', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","image":[{"count":4,"list":[]}],"goods":[{"count":40,"gc_id":0,"sort":"new","if_fix":0,"goods_id":[]},{"count":40,"gc_id":0,"sort":"new","if_fix":0,"goods_id":[]},{"count":40,"gc_id":0,"sort":"new","if_fix":0,"goods_id":[]},{"count":40,"gc_id":0,"sort":"new","if_fix":0,"goods_id":[]}]}'),
(12, '导航列表', '', '', '', 'h5', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","image":[{"count":5,"list":[]}],"text":[{"count":5,"list":[]}],"link":[{"count":5,"list":[]}]}'),
(13, '滚动通知', '左侧图片94*44px', '', '', 'h5', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","image":[{"count":1,"list":[]}],"text":{"1":{"count":5,"list":[]}},"link":{"1":{"count":5,"list":[]}}}'),
(14, '分类切换图片', '分类图片100*100px，上下结构，上部分为初始状态图标，下部分为活动状态图标。下方广告图尺寸112*154px', '', '', 'h5', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","image":[{"count":2,"list":[]},{"count":3,"list":[]},{"count":3,"list":[]}],"link":{"1":{"count":3,"list":[]},"2":{"count":3,"list":[]}}}'),
(15, '商品排行', '', '', '', 'h5', '{"back_color":"unset","margin_top":"0","margin_bottom":"0","goods":[{"count":10,"gc_id":0,"sort":"new","if_fix":0,"goods_id":[]}]}');
