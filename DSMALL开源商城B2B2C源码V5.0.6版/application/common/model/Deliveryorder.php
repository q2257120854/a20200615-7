...
class Deliveryorder extends Model {
     ...
     * @return array
     */
    public function getDeliveryorderList($condition = array(), $fields = '*', $pagesize = 0, $order = 'order_id desc', $limit = '') {
        if ($pagesize) {
            $res = db('deliveryorder')->field($fields)->where($condition)->order($order)->paginate($pagesize, false, ['query' => request()->param()]);
            $this->page_info = $res;
            return $res->items();
        } else {
     ...
     * @return array
     */
    public function getDeliveryorderDefaultList($condition = array(), $fields = '*', $pagesize = 0, $order = 'order_id desc', $limit = '') {
     ...
     * @return array
     */
    public function getDeliveryorderDefaultAndArriveList($condition = array(), $fields = '*', $pagesize = 0, $order = 'order_id desc', $limit = '') {
