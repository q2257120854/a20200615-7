...
class Refundreturn extends Model {
     ...
     * @return array
     */
    public function getReasonList($condition = array(), $pagesize = '', $limit = '', $fields = '*') {
        $result_paginate = db('refundreason')->field($fields)->where($condition)->order('reason_sort asc,reason_id desc')->paginate($pagesize,false,['query' => request()->param()]);
     ...
     * @return type
     */
    public function getRefundreturnList($condition = array(), $pagesize = '', $field = '*', $order = 'refund_id desc', $limit = '') {
        if ($pagesize) {
            $result = db('refundreturn')->field($field)->where($condition)->order($order)->paginate($pagesize,false,['query' => request()->param()]);
    ...
    public function getRefundList($condition = array(), $pagesize = '',$field = '*', $order = 'refund_id desc', $limit = '') {
     ...
     * @return type
     */
    public function getReturnList($condition = array(), $pagesize = '',$field = '*', $order = 'refund_id desc', $limit = '') {
