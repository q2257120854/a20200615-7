...
class Storejoin extends AdminControl
{
    public function _initialize()
    {
        ...
        Lang::load(APP_PATH . 'admin/lang/'.config('default_lang').'/storejoin.lang.php');
    }
    ...
    protected function getAdminItemList()
    {
        $menu_array = array(
            array(
                'name' => 'index', 'text' => lang('image_and_notice'), 'url' => url('Storejoin/index')
            ), array(
                'name' => 'help_list', 'text' => lang('joinin_guide'), 'url' => url('Storejoin/help_list')
            )
        );
