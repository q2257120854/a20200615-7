    ...
    public function general_list(){
        ...
        if ($gc_childarr){
            ...
            if (isset($this->search_arr['exporttype']) && $this->search_arr['exporttype'] == 'excel'){
                ...
                $statheader[] = array('text'=>lang('average_price').'（'.lang('currency_zh').'）','key'=>'priceavg','isorder'=>1);
                ...
                $statheader[] = array('text'=>lang('stattrade_order_amount').'（'.lang('currency_zh').'）','key'=>'orderamount','isorder'=>1);
        ...
        $statheader = array();
        $statheader[] = array('text'=>lang('ds_goodsclass'),'key'=>'gc_name');
        $statheader[] = array('text'=>'<span title="'.lang('goods_class_average_goods_price').'" class="tip iconfont">&#xe71c;</span>&nbsp;'.lang('average_price').'（'.lang('currency_zh').'）','key'=>'priceavg','isorder'=>1);
        ...
        $statheader[] = array('text'=>'<span title="'.lang('have_sale_goods_amount_recent').'" class="tip iconfont">&#xe71c;</span>&nbsp;'.lang('stattrade_order_amount').'（'.lang('currency_zh').'）','key'=>'orderamount','isorder'=>1);
