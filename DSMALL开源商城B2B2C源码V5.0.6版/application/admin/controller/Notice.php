...
//                $this->success(lang('notice_index_send_succ'), 'notice/notice');
    ...
    protected function getAdminItemList()
    {
        $menu_array=array(
            array(
                'name'=>'index','text'=>lang('notice_index_member_notice'),'url'=>url('Notice/index')
            ),
            array(
                'name'=>'notice','text'=>lang('notice_index_send'),'url'=>"javascript:dsLayerOpen('".url('Notice/notice')."','".lang('notice_index_send')."')"
            )
        );
        return $menu_array;
    }
