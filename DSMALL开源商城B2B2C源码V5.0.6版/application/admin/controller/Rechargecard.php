...
class Rechargecard extends AdminControl
{
    ...
    private function createExcel($data = array())
    {
        ...
        $excel_obj->generateXML($excel_obj->charset(lang('rechargecard'), CHARSET) . input('param.curpage') . '-' . date('Y-m-d-H', TIMESTAMP));
    }
    ...
    protected function getAdminItemList()
    {
        $menu_array = array(
            array(
                'name' => 'index', 'text' => lang('ds_list'), 'url' => url('Rechargecard/index')
            ), array(
                'name' => 'add_card', 'text' => lang('ds_new'),'url' => "javascript:dsLayerOpen('" . url('Rechargecard/add_card') . "','".lang('ds_new')."')"
            ),
        );
        return $menu_array;
    }
