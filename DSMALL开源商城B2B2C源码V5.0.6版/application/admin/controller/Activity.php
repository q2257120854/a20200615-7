...
class Activity extends AdminControl {
    ...
    public function add() {
        if (request()->isPost()) {
            ...
            $this->assign('editable_page_list',array());
    ...
    public function edit() {
        ...
        if (!request()->isPost()) {
            $this->assign('activity', $activity);
            $this->assign('editable_page_list',model('editable_page')->getEditablePageList(array('editable_page_path'=>'activity/detail','editable_page_item_id'=>$activity_id)));
            return $this->fetch('form');
        } else {
            //提交表单
            $data = [
    ...
    protected function getAdminItemList() {
        $menu_array = array(
            array(
                ...
                'name' => 'add',
                'text' => lang('ds_new'),
                'url' => "javascript:dsLayerOpen('".url('Activity/add')."','".lang('ds_new')."')"
            ),
        );
