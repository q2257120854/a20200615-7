...
class Consulting extends AdminControl {
    ...
    public function type_edit() {
        ...
        if (request()->isPost()) {
            ...
            if ($result) {
                $this->log(lang('edit_consulttype').' ID:' . $where['consulttype_id'], 1);
                dsLayerOpenSuccess(lang('ds_common_op_succ'));
            } else {
                $this->log(lang('edit_consulttype').' ID:' . $where['consulttype_id'], 0);
    ...
    protected function getAdminItemList() {
        $menu_array = array(
            ...
            array(
                ...
                'url' =>"javascript:dsLayerOpen('".url('Consulting/type_add')."','".lang('add_consulttype')."')"
