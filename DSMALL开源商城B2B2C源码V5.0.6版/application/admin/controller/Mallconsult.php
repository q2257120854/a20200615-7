...
class Mallconsult extends AdminControl {
    ...
    public function _initialize() {
        ...
        Lang::load(APP_PATH . 'admin/lang/'.config('default_lang').'/mallconsult.lang.php');
    }
    ...
    protected function getAdminItemList() {
        $menu_array = array(
            array(
                'name' => 'index', 'text' => lang('mallconsult_index'), 'url' => url('Mallconsult/index')
            ), array(
                'name' => 'type_list', 'text' => lang('mallconsult_type_list'), 'url' => url('Mallconsult/type_list')
            ), array(
                'name' => 'type_add', 'text' => lang('mallconsult_type_add'), 'url' =>"javascript:dsLayerOpen('".url('Mallconsult/type_add')."','".lang('mallconsult_type_add')."')"
            ),
        );
