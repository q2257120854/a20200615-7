...
class Dashboard extends AdminControl {
    ...
    private function _get_week_order()
    {
        ...
        $orderlist = db('order')->field($field)->where($where)->group('weekval,dayofweekval')->select();
    ...
    private function _get_week_goods() {
        ...
        $goodslist = db('goodscommon')->field($field)->where($where)->group('weekval,dayofweekval')->select();
