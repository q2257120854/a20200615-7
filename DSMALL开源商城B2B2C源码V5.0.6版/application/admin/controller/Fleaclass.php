...
class Fleaclass extends AdminControl
{
    ...
    protected function getAdminItemList()
    {
        $menu_array = array(
            array(
                'name' => 'index', 'text' => lang('ds_manage'), 'url' => url('Fleaclass/flea_class')
            ),
            array(
                'name' => 'add', 'text' => lang('ds_add'), 'url' => "javascript:dsLayerOpen('".url('Fleaclass/goods_class_add')."','".lang('ds_add')."')"
            ),
            array(
                'name' => 'export', 'text' => lang('ds_export'), 'url' => url('Fleaclass/goods_class_export')
            ),
            array(
                'name' => 'import', 'text' => lang('ds_import'), 'url' => url('Fleaclass/goods_class_import')
            ),
        );
        return $menu_array;
    }
