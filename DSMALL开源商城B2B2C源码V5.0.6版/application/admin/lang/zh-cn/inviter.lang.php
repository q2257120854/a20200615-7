...
$lang['inviter_setting'] = '分销设置';
$lang['inviter_goods'] = '分销商品';
$lang['inviter_member'] = '分销员管理';
$lang['inviter_memberclass'] = '分销员等级';
$lang['inviter_order'] = '分销员订单';

/* 分销设置 */
$lang['inviter_back'] = '分销背景图片';
$lang['inviter_back_tips'] = '推广背景图片，最佳显示尺寸为360*578像素';
...
$lang['inviter_ratio_1_notice'] = '基数为订单总商品金额，商家设置的一级分销比例不可超过此数';
$lang['inviter_ratio_2_notice'] = '基数为订单总商品金额，商家设置的二级分销比例不可超过此数';
$lang['inviter_ratio_3_notice'] = '基数为订单总商品金额，商家设置的三级分销比例不可超过此数';
