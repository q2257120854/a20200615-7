 ...
 * index
 */
$lang['groupbuy_quota'] = '套餐管理';
$lang['groupbuy_slider'] = '幻灯片管理';
...
$lang['groupbuy_buy_quantity'] = '购买数量';
$lang['group_name'] = '抢购名称';
$lang['goods_price'] = '商品原价';
$lang['groupbuy_price'] = '抢购价格';
$lang['groupbuy_price_tips'] = '抢购套餐价格，单位为元，购买周期为月(30天)';
$lang['groupbuy_review_day'] = '抢购审核期';
$lang['groupbuy_review_day_tips'] = '抢购审核期(天)，平台预留的审核天数，卖家只能发布审核期天数以后的抢购活动';
$lang['live_pic'] = '滚动图片';
 ...
 * 页面说明
 * */
$lang['groupbuy_price_range_help1'] = '抢购按价格筛选的区间，各个区间段的金额请不要重叠';
...
$lang['groupbuy_slider_help1'] = '该组幻灯片图片应用于抢购页面上部使用。';
$lang['groupbuy_slider_help2'] = '图片要求的格式是jpg/gif/png格式，宽度为970像素，高度为300像素的图片。';
$lang['groupbuy_slider_help3'] = '图片的链接地址格式是“http://网址...”，设定后将在显示页面中点击幻灯片将以另打开窗口的形式跳转到指定网址。';
$lang['groupbuy_slider_help4'] = '清空操作将删除抢购页面上的幻灯片图片，请注意操作';
...
$lang['groupbuy_class_list_help1'] = '抢购分类最多为2级分类，商家发布抢购活动时选择抢购分类，用于抢购聚合页对抢购活动进行筛选';
$lang['groupbuy_index_help1'] = '管理员可以审核新的抢购活动的申请、取消、进行中的抢购活动或者删除抢购活动';

/**
 * 轮播图
 */
$lang['confirm_clear'] = '确认清空虚拟抢购幻灯片设置?';
$lang['confirm_succ'] = '清空成功';
