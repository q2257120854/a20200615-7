...
$lang['merchant_process_refund_application']	= '商家处理退款申请';
$lang['refund_complete']	= '平台审核，退款完成';
$lang['buyer_refund_application']	= '买家退款申请';
$lang['applicant_buyers']	= '申请人（买家）';
$lang['refund_instructions']	= '退款说明';
$lang['credentials_upload']	= '凭证上传';
$lang['business_processing']	= '商家处理意见';
$lang['return_amount_buyer']	= '同意并经过平台确认后会将金额以预存款的形式返还给买家。';
$lang['platform_complain_reapply']	= '不同意时买家可以向平台投诉或再次申请。';
...
$lang['consignee_space']	= '收&nbsp;&nbsp;货&nbsp;&nbsp;人';
$lang['contact_number']	= '联系电话';

//view
$lang['refund_check_mall_platform']	= '商城平台退款审核';
$lang['platform_note']	= '平台备注';

//controller
$lang['confirm_receipt_goods_completed'] = '确认收货完成';
$lang['refund_processing'] = '退款处理，退款编号';
...
$lang['refund_not_exist']	= '退货单不存在';
$lang['deliver_not_exist']	= '退货单没有物流信息';
$lang['deliver_search_fail']	= '物流信息查询失败';
$lang['deliver_not_exist']	= '不支持该物流';
