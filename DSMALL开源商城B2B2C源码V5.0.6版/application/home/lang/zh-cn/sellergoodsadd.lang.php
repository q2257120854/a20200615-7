...
$lang['store_goods_index_use_tpl'] = '使用售卖区域';
$lang['store_goods_index_select_tpl'] = '选择售卖区域';
...
$lang['store_goods_step3_groupbuy_activity'] = '抢购活动';
...
$lang['store_goods_import_csv_desc'] = '1.请使用标准的淘宝助理数据，表头必须包含: 
...
$lang['minimum_stock_warning_value'] = '设置最低库存预警值。当库存低于预警值时商家中心商品列表页库存列红字提醒。';
...
$lang['virtual_goods_instructions1'] = '*虚拟商品不能参加限时折扣和组合销售两种促销活动。也不能赠送赠品和推荐搭配。';
...
$lang['f_code_guidelines1'] = '*F码商品不能参加抢购、限时折扣和组合销售三种促销活动。也不能预售和推荐搭配。';
...
$lang['sellergoodsadd_f_code'] = 'F码';
$lang['sellergoodsadd_employ'] = '使用';
$lang['sellergoodsadd_unused'] = '未用';
$lang['sellergoodsadd_presell'] = '预售';
$lang['booking_information'] = '*预售商品不能参加抢购、限时折扣和组合销售三种促销活动。也不能推荐搭配。';
$lang['delivery_date'] = '发货日期';
$lang['merchant_delivery_time'] = '商家发货时间';
...
$lang['booking_information'] = '只有库存为零的商品才可以设为预约商品。商家补货后，平台自动发布消息通知已经预约的会员。';
...
$lang['shop_recommendation'] = '店铺推荐商品';
$lang['commend'] = '荐';
...
$lang['no_color'] = '无颜色';
$lang['wait_verify_0'] = '未通过';
$lang['wait_verify_10'] = '等待审核';
$lang['goods_not_exist_or_lock'] = '您的商品不存在，或商品已被锁定，请联系管理员删除促销解除锁定';

$lang['goodsfcode_code'] = '号码';
$lang['goodsfcode_state'] = '使用状态';
$lang['goodsfcode_state_1'] = '已使用';
$lang['goodsfcode_state_0'] = '未使用';
$lang['edit_image'] = '编辑图片';
$lang['add_gift'] = '赠送赠品';
$lang['add_combo'] = '推荐组合';
$lang['edit_class'] = '选择分类';

$lang['edit_storage'] = '修改库存';