...
class Sellermsg extends BaseSeller {
    ...
    protected function getSellerItemList() {
        $menu_array = array(
            1 => array('name' => 'msg_list', 'text' => lang('system_message'), 'url' => url('Sellermsg/index')), 2 => array(
                'name' => 'msg_setting', 'text' => lang('receiving_setting'), 'url' => url('Sellermsg/msg_setting')
            ),
        );
        if (!$this->checkIsAdmin()) {
            unset($menu_array[2]);
