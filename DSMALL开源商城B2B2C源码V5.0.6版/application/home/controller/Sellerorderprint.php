...
class Sellerorderprint extends BaseSeller {
    ...
    public function index() {
        ...
        if (!empty($store_info['store_avatar'])) {
            if (file_exists(BASE_UPLOAD_PATH . DS . ATTACH_STORE . DS .$store_info['store_id']. DS .$store_info['store_avatar'])) {
                $store_info['store_avatar'] = UPLOAD_SITE_URL . DS . ATTACH_STORE . DS .$store_info['store_id']. DS .$store_info['store_avatar'];
            } else {
