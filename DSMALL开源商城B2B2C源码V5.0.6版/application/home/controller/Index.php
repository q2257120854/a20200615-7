...
class Index extends BaseMall {
    ...
    private function getIndexData()
    {
        ...
        if (empty($index_data)) {
            $index_data = array();
            $index_data['recommend_list'] = model('goods')->getGoodsUnionList(array('goodscommon.mall_goods_commend' => 1), 'goods.goods_id,goodscommon.goods_name,goodscommon.goods_advword,goodscommon.goods_image,goodscommon.store_id,goods.goods_promotion_price,goodscommon.goods_price','goodscommon.mall_goods_sort asc','goodscommon.goods_commonid', 0,5);
            //限时折扣
    ...
    private function getFloorList($cate_id) {
        ...
        if (empty($result)) {
            ...
            $goods_list[0]['gc_list'] = model('goods')->getGoodsUnionList(array('goodscommon.gc_id' => $cate_id),'goods.goods_id,goodscommon.goods_marketprice,goodscommon.goods_name,goodscommon.goods_advword,goodscommon.goods_image,goodscommon.store_id,goods.goods_promotion_price,goodscommon.goods_price','goodscommon.mall_goods_commend desc,goodscommon.mall_goods_sort asc','goodscommon.goods_commonid', 0,10);
            ...
            foreach ($hot_goods_class_list as $key => $hot_goods_class) {
                ...
                $data['gc_list'] = model('goods')->getGoodsUnionList(array('goodscommon.gc_id' => $data['gc_id']),'goods.goods_id,goodscommon.goods_marketprice,goodscommon.goods_name,goodscommon.goods_advword,goodscommon.goods_image,goodscommon.store_id,goods.goods_promotion_price,goodscommon.goods_price','goodscommon.mall_goods_commend desc,goodscommon.mall_goods_sort asc','goodscommon.goods_commonid', 0,10);
                $goods_list[] = $data;
            }
