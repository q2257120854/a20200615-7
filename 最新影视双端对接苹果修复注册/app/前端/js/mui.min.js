			...
			if (hasPulldown || hasPullup) {
				...
				if (container) {
					...
					if ($container.length === 1) {
						/*if ($.os.plus && $.os.android) {  //android 5+   //蓝鸟修改!!!
							$.plusReady(function() {
...
(function($, window, undefined) {
	...
	$.ajax = function(url, options) {
		...
		var mime;
		//以下是蓝鸟修改
		if(settings.charset_accept=="gbk"){
            mime = settings.accepts_gbk[dataType && dataType.toLowerCase()];
		}else{
            mime = settings.accepts_utf8[dataType && dataType.toLowerCase()];
		}
		//以上是蓝鸟修改
		var headers = {};
