...
<form action="adm_bbs.php" method="post" name="suer" id="suer">
<input type="text" name="id" class="am-form-field" placeholder="搜索帖子ID"/><br><input class="am-btn  am-btn-default am-btn-success tpl-am-btn-success am-icon-search" value="搜索" type="submit"></input>
</form>
                 </div>
                    <div class="am-g">
...
<?php
 ...
 if($id != ''){
 $sql="select * from bbspost where id='$id' order by time desc limit $bnums,$enums";
 }else{
