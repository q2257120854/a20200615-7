...
if($submit){
	...
	$query=$db->query($sql);
	if($query){
		echo "<script>alert('清理成功');location.href='adm_kami.php';</script>";
	}
}else{
                                ...
                                <a href="add_kami.php">
                                    ...
                                    <a href="out_kami.php">
                                       <i class="am-icon-angle-right"></i>
                                        ...
                                        <a href="del_kami.php" class="active" >
                                            <i class="am-icon-angle-right"></i>
                                            <span>卡密清理</span>
...
<div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li class="am-active">卡密清理</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 卡密清理
                    </div>
                </div>
<form action="" method="post" id="addimg" name="addimg">
<div id="post">
<div>
	<input type="submit" name="submit" value="清理已用卡密" class="am-btn-primary" />
</div>
</div>
</form>
</div></div>
<script> 
var div = document.getElementById('del_kami'); 
