...
$txt=str_replace("\r\n","",$txt);
$time2 = gmdate("Y-m-d",time()+8*3600);
...
if($submit){
    ...
    if($have) exit("<script>alert('此视频已存在,请勿重复上传');location.href='';</script>");
	...
	$sql="INSERT INTO `shipin_data`(`name`,`src`,`href`,`txt`,`time`,`shipfl`) VALUES ('$name','$src','$href','$txt','$time','$shipfl')";
	$query=$db->query($sql);
	if($query){
                ...
                <ul class="tpl-left-nav-menu">
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display: block;">
                           <li>
                                <a href="shipin_sc.php" class="active">
                                    <i class="am-icon-angle-right"></i>
                                    <span>上传视频</span>
...
<div class="am-form-group">
 ...
 <div class="am-form-group">
    <input class="mdui-textfield-input mdui-col-md-11 "  type="text" name="name" id="name"/>
</div></div>
<br>
...
<div class="am-form-group">
 ...
 <div class="am-form-group">
    <input class="mdui-textfield-input mdui-col-md-11 " value="<?php echo $time2 ?>"  type="text" name="time" id="time"/>
</div></div>
<br>

<div class="am-form-group">
    <label class="mdui-textfield-label"  for="src" id="regip_label">视频图片地址:</label>
    <input class="mdui-textfield-input mdui-col-md-11 "  type="text" name="src" id="src"/>
</div>
<br>

<div class="am-form-group">
    <label class="mdui-textfield-label"  for="href" id="regip_label">视频播放地址：</label>
    <textarea  type="text" class="mdui-textfield-input mdui-col-md-11" style="height:100px;"  name="href" id="href"></textarea><font color=red>电影格式：http://www.****.mp4 <br>多条播放地址可用 | 或 换行符 分开, 例如：第1集$http://www.****.mp4|第2集$http://www.****.m3u8  不要有空格</font>
</div>
<br>

<div class="am-form-group">
    <label class="mdui-textfield-label"  for="txt" id="regip_label">视频简介：</label>
    <textarea  type="text" class="mdui-textfield-input mdui-col-md-11" style="height:100px;"  name="txt" id="txt"></textarea>
</div>
<br>

<br>
<div id="post_button">
    <input  type="submit" name="submit" value="上传视频" class="am-btn-primary" />
</div>
</div>
</form>
</div></div></div> 
