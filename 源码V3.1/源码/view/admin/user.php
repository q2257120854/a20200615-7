<?php require_once 'header.php' ?>
    ...
    <div class="set set0  table-responsive">
      <div class="panel panel-default">
        <div class="panel-body">
            <form class="form-inline" action="" method="get">
                ...
                <div class="form-group"><select name="lid" class="form-control">
                        <option value="-1"<?php echo $search['lid'] == '-1' ? ' selected' : '' ?>>全部等级
                                </option>
        ...
        <div class="panel-body">
            <button onclick="checkOrder('/admin/user/checkUser',9)" type="button"
                    class="btn btn-danger">
                    <span class="glyphicon glyphicon-trash">
                    </span>
                &nbsp;删除
            </button>
            <button onclick="checkOrder('/admin/user/checkUser',0)" type="button"
                    class="btn btn-info">
                    <span class="glyphicon glyphicon-pencil">
                    </span>
                &nbsp;禁用
            </button>
            <button onclick="checkOrder('/admin/user/checkUser',1)" type="button"
    ...
    <table class="table table-hover">
        ...
        <tbody>
                ...
                <?php foreach ($lists as $key => $val): ?>
                    ...
                    <td>￥<?php echo $val['allmoney']?></td>
                    <td><?php echo $val['last_ip']?></td>
                    <td> <?php echo date('Y-m-d H:i', $val['ctime']) ?> </td>
                    ...
                    <td>
                        ...
                        <a href="<?php echo $this->dir?>orders?uid=<?php echo $val['id']?>" data-toggle="tooltip"
						   ...
						   <a href="javascript:;" onclick="del(<?php echo $val['id']?>,'<?php echo $this->dir?>user/del')"
...
<div class="set set1 hide">
    <form class="form-ajax form-horizontal" action="<?php echo $this->dir?>/user/save"
