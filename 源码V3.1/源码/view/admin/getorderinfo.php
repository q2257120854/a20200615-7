    ...
    <div class="panel-body">
        <table class="customize">
            ...
            <tr>
                ...
                <td>
                    <?php
                    switch($orders['is_state']){
                        case '0':
                            $state='<span class="label label-warning">未付</span>';
                            break;
                            case '1': $state='<span class="label label-success">已付</span>' ;
                            break;
                            case '2': $state='<span class="label label-danger">冻结</span>' ;
                            break;
                            case '3': $state='<span class="label label-default">关闭</span>' ;
                            break;
                    }
                    echo $state;?>
                </td>
