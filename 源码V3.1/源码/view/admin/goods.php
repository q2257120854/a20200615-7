            ...
            <?php if ($lists): ?>
                <?php foreach ($lists as $key => $val): ?>
                    <tr data-id="<?php echo $val['id'] ?>">
						...
						<?php foreach ($ulevel as $key => $valu): ?>     
           				 <td>
                            <?php echo $val["money{$valu['id']}"]?>￥
                        </td>  
                  		<?php endforeach; ?>   
                        <td>
                            <?php if ($val['type'] == 0){
								echo '<span class="label label-success">自动发卡</span>';
							}else{
								 echo '<span class="label label-warning">手工商品</span>';
							}
							?>
                        </td>
                        <td>
                        ...
                        <td>
                            <a target="_blank" href="../../product?id=<?php echo $val['id']; if($val['pwd'] ){ echo "&pwd=".$val['pwd'];} ?>" data-toggle="tooltip"
                               title="链接">
    ...
    <div class="set set1 hide">
        <form class="form-horizontal" action="<?php echo $this->dir ?>goods/save"
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                   <input type="text" name="image" id="upload2" required >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" name="pwd" id="pwd" class="form-control" value="">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" name="gmoney" id="gmoney" class="form-control" required value="100">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" name="money<?php echo $val['id'] ?>" id="money<?php echo $val['id'] ?>" class="form-control" required value="100">
                </div>
            </div>
                  <?php endforeach; ?>   
            <div class="form-group">
