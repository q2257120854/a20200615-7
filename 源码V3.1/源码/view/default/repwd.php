...
<div class="am-g tpl-g">
    ...
    <div class="tpl-login">
        ...
        <div class="tpl-login-content">
            ...
            <form class="am-form tpl-form-line-form form-ajax" action="<?php echo $this->dir ?>/reg/resave" method="post" > 
              <input type="hidden" name="token" class="tpl-form-input" value="<?php echo $token; ?>">
                <div class="am-form-group">
