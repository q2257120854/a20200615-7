...
<div class="am-g tpl-g">
    ...
    <div class="tpl-login">
        <div class="tpl-login-content">
            ...
            <form class="form-ajax am-form tpl-form-line-form" action="<?php echo $this->dir ?>/login/sigin" method="post">
                <div class="am-form-group">
                    <input type="text" name="username" class="tpl-form-input"  placeholder="用户名" required>
                </div>

                <div class="am-form-group">
                    <input type="password" name="password" class="tpl-form-input"  placeholder="请输入密码" required>
                </div>
 				<div class="am-form-group">
                                    <input type="text" class="tpl-form-input" name="chkcode" id="chkcode" placeholder="验证码"
                                    maxlength="5" required>
                                    <div style="background:#fff;border:1px solid #e5e5e5;border-top:0;padding:5px 0;border-radius:3px;text-align:center">
                                        <img src="/chkcode?rnd=<?php echo rand(); ?>" onclick="javascript:this.src='/chkcode?rnd='+new Date().getTime()"
